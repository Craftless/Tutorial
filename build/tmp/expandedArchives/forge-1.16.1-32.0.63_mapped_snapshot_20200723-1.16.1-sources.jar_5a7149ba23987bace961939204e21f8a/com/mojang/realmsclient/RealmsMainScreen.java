...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void func_223901_c() {
      ...
      this.field_224023_l = this.addButton(new Button(this.width / 2 + 4, this.height - 32, 90, 20, DialogTexts.field_240637_h_, (p_237632_1_) -> {
            ...
            public void run() {
               try {
                  ...
                  if (realmsserver != null) {
                     ...
                     RealmsMainScreen.this.field_224020_i.getEventListeners().removeIf((p_237669_1_) -> {
                        return p_237669_1_ instanceof RealmsMainScreen.ServerEntry && ((RealmsMainScreen.ServerEntry)p_237669_1_).field_223734_a.field_230582_a_ == RealmsMainScreen.this.field_224021_j;
                     });
                     RealmsMainScreen.this.field_224020_i.setSelected((RealmsMainScreen.ListEntry)null);
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224037_z && !this.field_223993_A && this.func_223990_b()) {
         ...
         AbstractGui.blit(matrixStack, this.field_224009_Q.x + this.field_224009_Q.getWidth() - 8 - 4, this.field_224009_Q.y + this.field_224009_Q.getWidth_CLASH() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
      }
   ...
   private void func_237605_b_(MatrixStack p_237605_1_, int p_237605_2_, int p_237605_3_) {
      int i = this.func_223989_B();
      int j = this.func_223932_C();
      ITextComponent itextcomponent = new TranslationTextComponent("mco.selectServer.popup");
      List<ITextProperties> list = this.font.func_238425_b_(itextcomponent, 100);
      if (!this.field_223994_B) {
      ...
      for(ITextProperties itextproperties : list) {
         ++l;
         int i1 = j + 10 * l - 3;
         this.font.func_238422_b_(p_237605_1_, itextproperties, (float)(this.width / 2 + 52), (float)i1, 5000268);
      }
   ...
   private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_, int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_) {
      ...
      if (flag4) {
         String s = i == 0 ? "mco.invites.nopending" : "mco.invites.pending";
         String s1 = I18n.format(s);
         int i1 = this.font.getStringWidth(s1);
         this.fillGradient(p_237581_1_, j1 - 3, p_237581_3_ - 3, j1 + i1 + 3, p_237581_3_ + 8 + 3, -1073741824, -1073741824);
         this.font.drawStringWithShadow(p_237581_1_, s1, (float)j1, (float)p_237581_3_, -1);
      }
   ...
   protected void func_237583_a_(MatrixStack p_237583_1_, List<ITextComponent> p_237583_2_, int p_237583_3_, int p_237583_4_) {
      if (!p_237583_2_.isEmpty()) {
         ...
         for(ITextComponent itextcomponent1 : p_237583_2_) {
            ...
            this.font.func_238407_a_(p_237583_1_, itextcomponent1, (float)i1, (float)(j1 + i), 16777215);
            i += 10;
         }
   ...
   class InfoButton extends Button {
      ...
      public void renderButton(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
         RealmsMainScreen.this.func_237580_a_(p_230431_1_, p_230431_2_, p_230431_3_, this.x, this.y, this.isHovered());
      }
   }
   ...
   class NewsButton extends Button {
      ...
      public void renderButton(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
         RealmsMainScreen.this.func_237582_a_(p_230431_1_, p_230431_2_, p_230431_3_, RealmsMainScreen.this.field_223995_C, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class PendingInvitesButton extends Button implements IScreen {
      ...
      public void renderButton(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
         RealmsMainScreen.this.func_237581_a_(p_230431_1_, p_230431_2_, p_230431_3_, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class ServerEntry extends RealmsMainScreen.ListEntry {
      ...
      private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_, int p_237679_5_, int p_237679_6_) {
         if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            ...
            int j2 = -16777216 | (int)(127.0F * f) << 16 | (int)(255.0F * f) << 8 | (int)(127.0F * f);
            RealmsMainScreen.this.drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, I18n.format("mco.selectServer.uninitialized"), p_237679_3_ + 10 + 40 + 75, p_237679_4_ + 12, j2);
         } else {
            int i = 225;
            int j = 2;
            ...
            if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_) {
               ...
               String s2 = I18n.format("mco.selectServer.expiredList");
               String s3 = I18n.format("mco.selectServer.expiredRenew");
               if (p_237679_1_.field_230592_k_) {
                  s2 = I18n.format("mco.selectServer.expiredTrial");
                  s3 = I18n.format("mco.selectServer.expiredSubscribe");
               }

               int l2 = RealmsMainScreen.this.font.getStringWidth(s3) + 17;
               int l = 16;
               int i1 = p_237679_3_ + RealmsMainScreen.this.font.getStringWidth(s2) + 8;
               int j1 = p_237679_4_ + 13;
               boolean flag = false;
               if (p_237679_5_ >= i1 && p_237679_5_ < i1 + l2 && p_237679_6_ > j1 && p_237679_6_ <= j1 + 16 & p_237679_6_ < RealmsMainScreen.this.height - 40 && p_237679_6_ > 32 && !RealmsMainScreen.this.func_223990_b()) {
                  flag = true;
                  RealmsMainScreen.this.field_237539_ap_ = RealmsMainScreen.ServerState.EXPIRED;
               }

               int k1 = flag ? 2 : 1;
               AbstractGui.blit(p_237679_2_, i1, j1, 0.0F, (float)(46 + k1 * 20), l2 / 2, 8, 256, 256);
               AbstractGui.blit(p_237679_2_, i1 + l2 / 2, j1, (float)(200 - l2 / 2), (float)(46 + k1 * 20), l2 / 2, 8, 256, 256);
               AbstractGui.blit(p_237679_2_, i1, j1 + 8, 0.0F, (float)(46 + k1 * 20 + 12), l2 / 2, 8, 256, 256);
               AbstractGui.blit(p_237679_2_, i1 + l2 / 2, j1 + 8, (float)(200 - l2 / 2), (float)(46 + k1 * 20 + 12), l2 / 2, 8, 256, 256);
               RenderSystem.disableBlend();
               int l1 = p_237679_4_ + 11 + 5;
               int i2 = flag ? 16777120 : 16777215;
               RealmsMainScreen.this.font.drawString(p_237679_2_, s2, (float)(p_237679_3_ + 2), (float)(l1 + 1), 15553363);
               RealmsMainScreen.this.drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, s3, i1 + l2 / 2, l1 + 1, i2);
            } else {
               if (p_237679_1_.field_230594_m_ == RealmsServer.ServerType.MINIGAME) {
                  int k2 = 13413468;
                  String s1 = I18n.format("mco.selectServer.minigame") + " ";
                  int k = RealmsMainScreen.this.font.getStringWidth(s1);
                  RealmsMainScreen.this.font.drawString(p_237679_2_, s1, (float)(p_237679_3_ + 2), (float)(p_237679_4_ + 12), 13413468);
   ...
   class ServerList extends RealmsObjectSelectionList<RealmsMainScreen.ListEntry> {
      ...
      public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
         if (p_231044_5_ == 0 && mouseX < (double)this.getScrollbarPosition() && mouseY >= (double)this.y0 && mouseY <= (double)this.y1) {
   ...
   class TrialServerEntry extends RealmsMainScreen.ListEntry {
      ...
      private void func_237681_a_(MatrixStack p_237681_1_, int p_237681_2_, int p_237681_3_, int p_237681_4_, int p_237681_5_, int p_237681_6_) {
         int i = p_237681_4_ + 8;
         int j = 0;
         String s = I18n.format("mco.trial.message.line1") + "\\n" + I18n.format("mco.trial.message.line2");
         boolean flag = false;
         ...
         for(String s1 : s.split("\\\\n")) {
            RealmsMainScreen.this.drawCenteredString(p_237681_1_, RealmsMainScreen.this.font, s1, RealmsMainScreen.this.width / 2, i + j, k);
            j += 10;
         }
