...
public class RealmsConfirmScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224142_b, this.width / 2, func_239562_k_(3), 16777215);
      this.drawCenteredString(matrixStack, this.font, this.field_224146_f, this.width / 2, func_239562_k_(5), 16777215);
