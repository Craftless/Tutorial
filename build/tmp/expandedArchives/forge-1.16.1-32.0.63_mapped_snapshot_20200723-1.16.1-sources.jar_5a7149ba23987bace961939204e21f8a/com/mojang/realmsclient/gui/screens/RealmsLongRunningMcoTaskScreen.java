...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen implements IErrorConsumer {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224243_g, this.width / 2, func_239562_k_(3), 16777215);
      if (!this.field_224244_h) {
         this.drawCenteredString(matrixStack, this.font, field_224237_a[this.field_224247_k % field_224237_a.length], this.width / 2, func_239562_k_(8), 8421504);
      }

      if (this.field_224244_h) {
         this.drawCenteredString(matrixStack, this.font, this.field_224245_i, this.width / 2, func_239562_k_(8), 16711680);
      }
