...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.field_224419_g - 80 + 8, func_239562_k_(13) - 5, 70, 20, DialogTexts.field_240637_h_, (p_237808_1_) -> {
         this.func_224390_d();
      }));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, I18n.format("mco.configure.worlds.title"), this.width / 2, func_239562_k_(4), 16777215);
      super.render(matrixStack, mouseX, mouseY, partialTicks);
      if (this.field_224416_d == null) {
         this.drawCenteredString(matrixStack, this.font, I18n.format("mco.configure.world.title"), this.width / 2, 17, 16777215);
      } else {
         ...
         int k = this.font.getStringWidth(I18n.format("mco.configure.world.title"));
         this.drawCenteredString(matrixStack, this.font, I18n.format("mco.configure.world.title"), this.width / 2, 12, 16777215);
         this.drawCenteredString(matrixStack, this.font, s, this.width / 2, 24, j);
         int l = Math.min(this.func_224374_a(2, 3) + 80 - 11, this.width / 2 + i / 2 + k / 2 + 10);
         this.func_237807_c_(matrixStack, l, 7, mouseX, mouseY);
         if (this.func_224376_g()) {
            this.font.drawString(matrixStack, I18n.format("mco.configure.current.minigame") + ": " + this.field_224416_d.func_230778_c_(), (float)(this.field_224418_f + 80 + 20 + 10), (float)func_239562_k_(13), 16777215);
         }
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            this.minecraft.execute(() -> {
               this.minecraft.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_241827_a_(realmsserviceexception.getMessage()), this.field_224415_c));
            });
         }
   ...
   protected void func_237796_a_(MatrixStack p_237796_1_, ITextComponent p_237796_2_, int p_237796_3_, int p_237796_4_) {
      ...
      this.font.func_238407_a_(p_237796_1_, p_237796_2_, (float)i, (float)j, 16777215);
   }
   ...
   private void func_237809_d_(MatrixStack p_237809_1_, int p_237809_2_, int p_237809_3_, int p_237809_4_, int p_237809_5_) {
      ...
      if (p_237809_4_ >= p_237809_2_ && p_237809_4_ <= p_237809_2_ + 9 && p_237809_5_ >= p_237809_3_ && p_237809_5_ <= p_237809_3_ + 27) {
         this.field_224414_b = new TranslationTextComponent("mco.selectServer.expired");
      }
   ...
   private void func_237804_b_(MatrixStack p_237804_1_, int p_237804_2_, int p_237804_3_, int p_237804_4_, int p_237804_5_, int p_237804_6_) {
      ...
      if (p_237804_4_ >= p_237804_2_ && p_237804_4_ <= p_237804_2_ + 9 && p_237804_5_ >= p_237804_3_ && p_237804_5_ <= p_237804_3_ + 27) {
         if (p_237804_6_ <= 0) {
            this.field_224414_b = new TranslationTextComponent("mco.selectServer.expires.soon");
         } else if (p_237804_6_ == 1) {
            this.field_224414_b = new TranslationTextComponent("mco.selectServer.expires.day");
         } else {
   ...
   private void func_237811_e_(MatrixStack p_237811_1_, int p_237811_2_, int p_237811_3_, int p_237811_4_, int p_237811_5_) {
      ...
      if (p_237811_4_ >= p_237811_2_ && p_237811_4_ <= p_237811_2_ + 9 && p_237811_5_ >= p_237811_3_ && p_237811_5_ <= p_237811_3_ + 27) {
         this.field_224414_b = new TranslationTextComponent("mco.selectServer.open");
      }
   ...
   private void func_237813_f_(MatrixStack p_237813_1_, int p_237813_2_, int p_237813_3_, int p_237813_4_, int p_237813_5_) {
      ...
      if (p_237813_4_ >= p_237813_2_ && p_237813_4_ <= p_237813_2_ + 9 && p_237813_5_ >= p_237813_3_ && p_237813_5_ <= p_237813_3_ + 27) {
         this.field_224414_b = new TranslationTextComponent("mco.selectServer.closed");
      }
