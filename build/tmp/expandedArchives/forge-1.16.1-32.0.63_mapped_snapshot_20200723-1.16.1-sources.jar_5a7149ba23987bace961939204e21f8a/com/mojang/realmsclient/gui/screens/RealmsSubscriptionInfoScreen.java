...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 2 - 100, func_239562_k_(12), 200, 20, DialogTexts.field_240637_h_, (p_238071_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224586_h, this.width / 2, 17, 16777215);
      this.font.drawString(matrixStack, this.field_224587_i, (float)i, (float)func_239562_k_(0), 10526880);
      ...
      if (this.field_224592_n == Subscription.Type.NORMAL) {
         this.font.drawString(matrixStack, this.field_224588_j, (float)i, (float)func_239562_k_(3), 10526880);
      } else if (this.field_224592_n == Subscription.Type.RECURRING) {
         this.font.drawString(matrixStack, this.field_224589_k, (float)i, (float)func_239562_k_(3), 10526880);
      }

      this.font.drawString(matrixStack, this.func_224576_a(this.field_224590_l), (float)i, (float)func_239562_k_(4), 16777215);
