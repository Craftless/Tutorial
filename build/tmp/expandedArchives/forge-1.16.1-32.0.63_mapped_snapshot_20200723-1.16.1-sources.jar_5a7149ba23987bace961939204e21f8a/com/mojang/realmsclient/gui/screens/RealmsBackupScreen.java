...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width - 100, this.height - 35, 85, 20, DialogTexts.field_240637_h_, (p_237748_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawString(matrixStack, I18n.format("mco.configure.world.backup"), (float)((this.width - 150) / 2 - 90), 20.0F, 10526880);
      if (this.field_224125_l) {
         this.font.drawString(matrixStack, I18n.format("mco.backup.nobackups"), 20.0F, (float)(this.height / 2 - 10), 16777215);
      }
   ...
   protected void func_237744_a_(MatrixStack p_237744_1_, String p_237744_2_, int p_237744_3_, int p_237744_4_) {
      if (p_237744_2_ != null) {
         int i = p_237744_3_ + 12;
         int j = p_237744_4_ - 12;
         int k = this.font.getStringWidth(p_237744_2_);
         this.fillGradient(p_237744_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.font.drawStringWithShadow(p_237744_1_, p_237744_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class BackupObjectSelectionListEntry extends ExtendedList.AbstractListEntry<RealmsBackupScreen.BackupObjectSelectionListEntry> {
      ...
      private void func_237766_a_(MatrixStack p_237766_1_, int p_237766_2_, int p_237766_3_, int p_237766_4_, int p_237766_5_) {
         ...
         if (flag) {
            RealmsBackupScreen.this.field_224118_e = I18n.format("mco.backup.button.restore");
         }
      ...
      private void func_237768_b_(MatrixStack p_237768_1_, int p_237768_2_, int p_237768_3_, int p_237768_4_, int p_237768_5_) {
         ...
         RenderSystem.popMatrix();
         if (flag) {
            RealmsBackupScreen.this.field_224118_e = I18n.format("mco.backup.changes.tooltip");
         }
