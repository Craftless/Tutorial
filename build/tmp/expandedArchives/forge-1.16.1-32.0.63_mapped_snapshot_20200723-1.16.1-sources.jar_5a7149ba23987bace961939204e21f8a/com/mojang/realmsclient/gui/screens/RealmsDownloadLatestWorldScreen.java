...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.field_224180_f = this.addButton(new Button(this.width / 2 - 100, this.height - 42, 200, 20, DialogTexts.field_240633_d_, (p_237834_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224178_d, this.width / 2, 20, 16777215);
      this.drawCenteredString(matrixStack, this.font, this.field_224184_j, this.width / 2, 50, 16777215);
      ...
      if (this.field_224183_i != null) {
         this.drawCenteredString(matrixStack, this.font, this.field_224183_i, this.width / 2, 110, 16711680);
      }
   ...
   private void func_237836_c_(MatrixStack p_237836_1_) {
      ...
      this.drawCenteredString(p_237836_1_, this.font, this.field_224185_k + " %", this.width / 2, 84, 16777215);
   }
            ...
            if (field_237832_b_.tryLock(1L, TimeUnit.SECONDS)) {
               ...
               while(!filedownload.func_224835_b()) {
                  if (filedownload.func_224836_c()) {
                     ...
                     this.field_224180_f.setMessage(DialogTexts.field_240632_c_);
                     return;
                  }
