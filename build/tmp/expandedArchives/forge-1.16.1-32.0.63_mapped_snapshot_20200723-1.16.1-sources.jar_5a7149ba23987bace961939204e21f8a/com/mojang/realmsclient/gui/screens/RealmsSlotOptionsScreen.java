...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   private static final TranslationTextComponent field_238037_p_ = new TranslationTextComponent("mco.configure.world.on");
   private static final TranslationTextComponent field_238038_q_ = new TranslationTextComponent("mco.configure.world.off");
   ...
   public void init() {
      ...
      this.addButton(new Button(this.field_224645_h, func_239562_k_(13), this.field_224644_g, 20, DialogTexts.field_240633_d_, (p_238046_1_) -> {
         this.minecraft.displayGuiScreen(this.field_224638_a);
      }));
   ...
   private ITextComponent func_224610_c() {
      return (new TranslationTextComponent("selectWorld.gameMode")).appendString(": ").append(field_238036_b_[this.field_224650_m]);
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      String s = I18n.format("mco.configure.world.edit.slot.name");
      this.font.drawString(matrixStack, s, (float)(this.field_224643_f + this.field_224644_g / 2 - this.font.getStringWidth(s) / 2), (float)(func_239562_k_(0) - 5), 16777215);
