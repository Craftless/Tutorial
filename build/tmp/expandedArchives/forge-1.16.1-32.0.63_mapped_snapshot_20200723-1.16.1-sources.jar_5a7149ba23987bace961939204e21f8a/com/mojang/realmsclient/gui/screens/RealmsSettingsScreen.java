...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawString(matrixStack, I18n.format("mco.configure.world.name"), (float)(this.width / 2 - 106), (float)func_239562_k_(3), 10526880);
      this.font.drawString(matrixStack, I18n.format("mco.configure.world.description"), (float)(this.width / 2 - 106), (float)func_239562_k_(7), 10526880);
