...
public class RealmsGenericErrorScreen extends RealmsScreen {
   ...
   private void func_224224_a(RealmsServiceException p_224224_1_) {
      if (p_224224_1_.field_224983_c == -1) {
         ...
         this.field_224230_c = (ITextComponent)(I18n.hasKey(s) ? new TranslationTextComponent(s) : ITextComponent.func_241827_a_(p_224224_1_.field_224984_d));
      }
   ...
   public void init() {
    ...
    public boolean keyPressed(int key, int scanCode, int modifiers) {
        if (key == org.lwjgl.glfw.GLFW.GLFW_KEY_ESCAPE) {
            minecraft.displayGuiScreen(this.field_224228_a);
            return true;
        }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224229_b, this.width / 2, 80, 16777215);
      this.drawCenteredString(matrixStack, this.font, this.field_224230_c, this.width / 2, 100, 16711680);
