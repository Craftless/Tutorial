...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, I18n.format("mco.terms.title"), this.width / 2, 17, 16777215);
      this.font.drawString(matrixStack, I18n.format("mco.terms.sentence.1"), (float)(this.width / 2 - 120), (float)func_239562_k_(5), 16777215);
      ...
      int i1 = k + 1 + 9;
      if (j <= mouseX && mouseX <= l && k <= mouseY && mouseY <= i1) {
         this.field_224727_f = true;
         this.font.drawString(matrixStack, " " + I18n.format("mco.terms.sentence.2"), (float)(this.width / 2 - 120 + i), (float)func_239562_k_(5), 7107012);
      } else {
         this.field_224727_f = false;
         this.font.drawString(matrixStack, " " + I18n.format("mco.terms.sentence.2"), (float)(this.width / 2 - 120 + i), (float)func_239562_k_(5), 3368635);
      }
