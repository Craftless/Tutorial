...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawString(matrixStack, I18n.format("mco.reset.world.seed"), (float)(this.width / 2 - 100), (float)func_239562_k_(1), 10526880);
      this.field_224356_d.render(matrixStack, mouseX, mouseY, partialTicks);
      super.render(matrixStack, mouseX, mouseY, partialTicks);
   }

   private ITextComponent func_237937_g_() {
      return (new TranslationTextComponent("selectWorld.mapType")).appendString(" ").append(this.field_224353_a[this.field_224358_f]);
   }

   private ITextComponent func_237938_j_() {
      String s = this.field_224357_e ? "mco.configure.world.on" : "mco.configure.world.off";
      return (new TranslationTextComponent("selectWorld.mapFeatures")).appendString(" ").append(new TranslationTextComponent(s));
   }
}