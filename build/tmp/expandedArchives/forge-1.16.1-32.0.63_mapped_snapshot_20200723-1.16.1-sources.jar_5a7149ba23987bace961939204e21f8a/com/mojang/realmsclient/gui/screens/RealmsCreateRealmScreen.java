...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawString(matrixStack, I18n.format("mco.configure.world.name"), (float)(this.width / 2 - 100), 52.0F, 10526880);
      this.font.drawString(matrixStack, I18n.format("mco.configure.world.description"), (float)(this.width / 2 - 100), 102.0F, 10526880);
      if (this.field_224137_c != null) {
