...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.field_224079_i - 80 + 8, func_239562_k_(13) - 5, 70, 20, DialogTexts.field_240637_h_, (p_237776_1_) -> {
         this.func_224060_e();
      }));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_237769_r_, this.width / 2, 17, 16777215);

      for(int i = 0; i < this.field_224077_g.length; ++i) {
         this.drawCenteredString(matrixStack, this.font, this.field_224077_g[i], this.width / 2, func_239562_k_(-1) + 3 + i * 12, 10526880);
      }
   ...
   private void func_224068_a(long p_224068_1_) {
      (new Thread(() -> {
         ...
         try {
            ...
            this.minecraft.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_241827_a_(realmsserviceexception.getMessage()), this.field_224072_b));
         }
   ...
   private void func_237775_a_(MatrixStack p_237775_1_, int p_237775_2_, int p_237775_3_, int p_237775_4_, int p_237775_5_, boolean p_237775_6_, String p_237775_7_, int p_237775_8_, long p_237775_9_, String p_237775_11_, boolean p_237775_12_) {
      ...
      this.drawCenteredString(p_237775_1_, this.font, p_237775_7_, p_237775_2_ + 40, p_237775_3_ + 66, 16777215);
   }
}