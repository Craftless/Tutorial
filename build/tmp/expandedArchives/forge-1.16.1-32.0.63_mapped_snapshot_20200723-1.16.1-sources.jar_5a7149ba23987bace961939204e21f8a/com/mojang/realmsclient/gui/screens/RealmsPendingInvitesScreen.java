...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 2 - 50, this.height - 32, 100, 20, DialogTexts.field_240632_c_, (p_237875_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224337_e.getItemCount() == 0 && this.field_224336_d) {
         this.drawCenteredString(matrixStack, this.font, I18n.format("mco.invites.nopending"), this.width / 2, this.height / 2 - 20, 16777215);
      }

      super.render(matrixStack, mouseX, mouseY, partialTicks);
   }

   protected void func_237866_a_(MatrixStack p_237866_1_, String p_237866_2_, int p_237866_3_, int p_237866_4_) {
      if (p_237866_2_ != null) {
         int i = p_237866_3_ + 12;
         int j = p_237866_4_ - 12;
         int k = this.font.getStringWidth(p_237866_2_);
         this.fillGradient(p_237866_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.font.drawStringWithShadow(p_237866_1_, p_237866_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class InvitationEntry extends ExtendedList.AbstractListEntry<RealmsPendingInvitesScreen.InvitationEntry> {
      ...
      public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
         ListButton.func_237728_a_(RealmsPendingInvitesScreen.this.field_224337_e, this, this.field_223752_c, p_231044_5_, mouseX, mouseY);
         return true;
      }
      ...
      class AcceptButton extends ListButton {
         ...
         protected void func_230435_a_(MatrixStack p_230435_1_, int p_230435_2_, int p_230435_3_, boolean p_230435_4_) {
            ...
            if (p_230435_4_) {
               RealmsPendingInvitesScreen.this.field_224335_c = I18n.format("mco.invites.button.accept");
            }
      ...
      class RejectButton extends ListButton {
         ...
         protected void func_230435_a_(MatrixStack p_230435_1_, int p_230435_2_, int p_230435_3_, boolean p_230435_4_) {
            ...
            AbstractGui.blit(p_230435_1_, p_230435_2_, p_230435_3_, f, 0.0F, 18, 18, 37, 18);
            if (p_230435_4_) {
               RealmsPendingInvitesScreen.this.field_224335_c = I18n.format("mco.invites.button.reject");
            }
