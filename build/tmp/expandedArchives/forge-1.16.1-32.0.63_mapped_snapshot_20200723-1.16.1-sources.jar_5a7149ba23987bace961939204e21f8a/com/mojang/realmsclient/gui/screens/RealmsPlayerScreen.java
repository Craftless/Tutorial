...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.field_224307_h + this.field_224306_g / 2 + 2, func_239562_k_(12), this.field_224306_g / 2 + 10 - 2, 20, DialogTexts.field_240637_h_, (p_237907_1_) -> {
         this.func_224298_b();
      }));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224303_d != null && this.field_224303_d.field_230589_h_ != null) {
         this.font.drawString(matrixStack, I18n.format("mco.configure.world.invited") + " (" + this.field_224303_d.field_230589_h_.size() + ")", (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      } else {
         this.font.drawString(matrixStack, I18n.format("mco.configure.world.invited"), (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      }
   ...
   protected void func_237903_a_(MatrixStack p_237903_1_, String p_237903_2_, int p_237903_3_, int p_237903_4_) {
      if (p_237903_2_ != null) {
         int i = p_237903_3_ + 12;
         int j = p_237903_4_ - 12;
         int k = this.font.getStringWidth(p_237903_2_);
         this.fillGradient(p_237903_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.font.drawStringWithShadow(p_237903_1_, p_237903_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   private void func_237914_c_(MatrixStack p_237914_1_, int p_237914_2_, int p_237914_3_, int p_237914_4_, int p_237914_5_) {
      ...
      if (flag) {
         this.field_224301_b = I18n.format("mco.configure.world.invites.remove.tooltip");
      }
   ...
   private void func_237921_d_(MatrixStack p_237921_1_, int p_237921_2_, int p_237921_3_, int p_237921_4_, int p_237921_5_) {
      ...
      if (flag) {
         this.field_224301_b = I18n.format("mco.configure.world.invites.ops.tooltip");
      }
   ...
   private void func_237925_e_(MatrixStack p_237925_1_, int p_237925_2_, int p_237925_3_, int p_237925_4_, int p_237925_5_) {
      ...
      if (flag) {
         this.field_224301_b = I18n.format("mco.configure.world.invites.normal.tooltip");
      }
   ...
   class InvitedEntry extends ExtendedList.AbstractListEntry<RealmsPlayerScreen.InvitedEntry> {
      ...
      private void func_237932_a_(MatrixStack p_237932_1_, PlayerInfo p_237932_2_, int p_237932_3_, int p_237932_4_, int p_237932_5_, int p_237932_6_) {
         ...
         RealmsPlayerScreen.this.font.drawString(p_237932_1_, I18n.format("mco.configure.world.activityfeed.disabled"), (float)RealmsPlayerScreen.this.field_224307_h, (float)RealmsPlayerScreen.func_239562_k_(5), 10526880);
   ...
   class InvitedList extends RealmsObjectSelectionList<RealmsPlayerScreen.InvitedEntry> {
      ...
      public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_, int p_231401_7_) {
         if (p_231401_2_ >= 0 && p_231401_2_ <= RealmsPlayerScreen.this.field_224303_d.field_230589_h_.size() && RealmsPlayerScreen.this.field_224301_b != null) {
            if (!RealmsPlayerScreen.this.field_224301_b.equals(I18n.format("mco.configure.world.invites.ops.tooltip")) && !RealmsPlayerScreen.this.field_224301_b.equals(I18n.format("mco.configure.world.invites.normal.tooltip"))) {
               if (RealmsPlayerScreen.this.field_224301_b.equals(I18n.format("mco.configure.world.invites.remove.tooltip"))) {
                  RealmsPlayerScreen.this.func_224274_d(p_231401_2_);
               }
            } else if (RealmsPlayerScreen.this.field_224303_d.field_230589_h_.get(p_231401_2_).func_230763_c_()) {
