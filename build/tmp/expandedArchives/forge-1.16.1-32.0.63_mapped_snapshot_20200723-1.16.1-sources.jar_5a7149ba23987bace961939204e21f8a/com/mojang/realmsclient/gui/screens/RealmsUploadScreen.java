...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.field_224710_o = new Button(this.width / 2 - 100, this.height - 42, 200, 20, DialogTexts.field_240637_h_, (p_238087_1_) -> {
         this.func_224679_c();
      });
      this.field_224711_p = this.addButton(new Button(this.width / 2 - 100, this.height - 42, 200, 20, DialogTexts.field_240633_d_, (p_238084_1_) -> {
         this.func_224695_d();
      }));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_224704_i, this.width / 2, 50, 16777215);
      if (this.field_224708_m) {
      ...
      if (this.field_224703_h != null) {
         for(int i = 0; i < this.field_224703_h.length; ++i) {
            this.drawCenteredString(matrixStack, this.font, this.field_224703_h[i], this.width / 2, 110 + 12 * i, 16711680);
         }
      }
   ...
   private void func_238088_c_(MatrixStack p_238088_1_) {
      ...
      bufferbuilder.pos(d1 + 200.0D * d0 / 100.0D + 0.5D, 95.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      bufferbuilder.pos(d1 + 200.0D * d0 / 100.0D + 0.5D, 79.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      ...
      bufferbuilder.pos(d1 + 200.0D * d0 / 100.0D, 95.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      bufferbuilder.pos(d1 + 200.0D * d0 / 100.0D, 80.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      bufferbuilder.pos(d1, 80.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      tessellator.draw();
      RenderSystem.enableTexture();
      this.drawCenteredString(p_238088_1_, this.font, this.field_224705_j + " %", this.width / 2, 84, 16777215);
   }
      ...
      (new Thread(() -> {
         ...
         try {
               ...
               if (this.func_224692_a(file1)) {
                  ...
                  fileupload.func_224874_a((p_238082_3_) -> {
                     if (p_238082_3_.field_225179_a >= 200 && p_238082_3_.field_225179_a < 300) {
                        ...
                        this.field_224710_o.setMessage(DialogTexts.field_240632_c_);
            ...
            if (field_238081_b_.isHeldByCurrentThread()) {
               ...
               this.children.clear();
               this.addButton(this.field_224710_o);
               if (file1 != null) {
