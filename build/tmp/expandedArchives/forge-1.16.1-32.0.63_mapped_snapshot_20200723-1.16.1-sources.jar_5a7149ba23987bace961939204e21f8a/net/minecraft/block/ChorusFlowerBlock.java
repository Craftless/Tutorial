...
public class ChorusFlowerBlock extends Block {
   ...
   public ChorusFlowerBlock(ChorusPlantBlock plantBlock, AbstractBlock.Properties builder) {
      super(builder);
   ...
   private static void growTreeRecursive(IWorld worldIn, BlockPos p_185601_1_, Random rand, BlockPos p_185601_3_, int p_185601_4_, int iterations) {
      ...
      if (iterations < 4) {
         ...
         for(int k = 0; k < l; ++k) {
            ...
            if (Math.abs(blockpos1.getX() - p_185601_3_.getX()) < p_185601_4_ && Math.abs(blockpos1.getZ() - p_185601_3_.getZ()) < p_185601_4_ && worldIn.isAirBlock(blockpos1) && worldIn.isAirBlock(blockpos1.down()) && areAllNeighborsEmpty(worldIn, blockpos1, direction.getOpposite())) {
               ...
               growTreeRecursive(worldIn, blockpos1, rand, p_185601_3_, p_185601_4_, iterations + 1);
            }
         }
      }
