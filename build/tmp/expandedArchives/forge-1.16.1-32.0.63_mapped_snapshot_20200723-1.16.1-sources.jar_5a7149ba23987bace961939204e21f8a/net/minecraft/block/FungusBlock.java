...
public class FungusBlock extends BushBlock implements IGrowable {
   ...
   public FungusBlock(AbstractBlock.Properties properties, Supplier<ConfiguredFeature<HugeFungusConfig, ?>> fungusFeature) {
      super(properties);
   ...
   public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
      this.fungusFeature.get().func_236265_a_(worldIn, worldIn.func_241112_a_(), worldIn.getChunkProvider().getChunkGenerator(), rand, pos);
   }
}