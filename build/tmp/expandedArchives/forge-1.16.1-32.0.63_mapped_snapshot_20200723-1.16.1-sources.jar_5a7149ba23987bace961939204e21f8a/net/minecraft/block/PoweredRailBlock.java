...
public class PoweredRailBlock extends AbstractRailBlock {
   ...
   protected boolean findPoweredRailSignal(World worldIn, BlockPos pos, BlockState state, boolean p_176566_4_, int p_176566_5_) {
      if (p_176566_5_ >= 8) {
         ...
         if (this.isSamePoweredRail(worldIn, new BlockPos(i, j, k), p_176566_4_, p_176566_5_, railshape)) {
            return true;
         } else {
            return flag && this.isSamePoweredRail(worldIn, new BlockPos(i, j - 1, k), p_176566_4_, p_176566_5_, railshape);
         }
      }
   }

   protected boolean isSamePoweredRail(World world, BlockPos state, boolean p_208071_3_, int p_208071_4_, RailShape shape) {
         ...
         if (shape != RailShape.EAST_WEST || railshape != RailShape.NORTH_SOUTH && railshape != RailShape.ASCENDING_NORTH && railshape != RailShape.ASCENDING_SOUTH) {
            if (shape != RailShape.NORTH_SOUTH || railshape != RailShape.EAST_WEST && railshape != RailShape.ASCENDING_EAST && railshape != RailShape.ASCENDING_WEST) {
               if (isActivator == (((PoweredRailBlock) blockstate.getBlock()).isActivator)) {
                  return world.isBlockPowered(state) ? true : this.findPoweredRailSignal(world, state, blockstate, p_208071_3_, p_208071_4_ + 1);
               } else {
                  return false;
               }
            } else {
