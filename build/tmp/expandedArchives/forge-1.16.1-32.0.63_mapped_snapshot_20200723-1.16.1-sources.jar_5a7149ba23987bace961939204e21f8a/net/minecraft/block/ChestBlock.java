...
public class ChestBlock extends AbstractChestBlock<ChestTileEntity> implements IWaterLoggable {
   ...
   @Nullable
   public static IInventory getChestInventory(ChestBlock chest, BlockState state, World world, BlockPos pos, boolean p_226916_4_) {
      return chest.combine(state, world, pos, p_226916_4_).<Optional<IInventory>>apply(INVENTORY_MERGER).orElse((IInventory)null);
   }
