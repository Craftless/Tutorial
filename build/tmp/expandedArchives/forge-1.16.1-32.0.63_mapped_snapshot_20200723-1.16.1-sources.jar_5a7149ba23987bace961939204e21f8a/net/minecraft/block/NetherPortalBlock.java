...
public class NetherPortalBlock extends Block {
   ...
   public static boolean trySpawnPortal(IWorld world, BlockPos worldIn) {
      NetherPortalBlock.Size netherportalblock$size = isPortal(world, worldIn);
      if (netherportalblock$size != null && !net.minecraftforge.event.ForgeEventFactory.onTrySpawnPortal(world, worldIn, netherportalblock$size)) {
   ...
   @Nullable
   public static NetherPortalBlock.Size isPortal(IWorld world, BlockPos worldIn) {
      NetherPortalBlock.Size netherportalblock$size = new NetherPortalBlock.Size(world, worldIn, Direction.Axis.X);
      if (netherportalblock$size.isValid() && netherportalblock$size.portalBlockCount == 0) {
         return netherportalblock$size;
      } else {
         NetherPortalBlock.Size netherportalblock$size1 = new NetherPortalBlock.Size(world, worldIn, Direction.Axis.Z);
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      return !flag && !facingState.isIn(this) && !(new NetherPortalBlock.Size(worldIn, currentPos, direction$axis1)).validatePortal() ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
   }
   ...
   public static BlockPattern.PatternHelper createPatternHelper(IWorld world, BlockPos worldIn) {
      ...
      if (!netherportalblock$size.isValid()) {
         ...
         netherportalblock$size = new NetherPortalBlock.Size(world, worldIn, Direction.Axis.Z);
      }
