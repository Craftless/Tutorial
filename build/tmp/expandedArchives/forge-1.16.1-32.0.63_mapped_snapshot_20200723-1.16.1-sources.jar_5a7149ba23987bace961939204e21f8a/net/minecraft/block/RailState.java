...
public class RailState {
   ...
   public RailState(World worldIn, BlockPos pos, BlockState state) {
      ...
      RailShape railshape = this.block.getRailDirection(newState, worldIn, pos, null);
   ...
   private boolean func_208512_d(BlockPos pos) {
   ...
   public RailState placeRail(boolean p_226941_1_, boolean p_226941_2_, RailShape shape) {
      BlockPos blockpos = this.pos.north();
      BlockPos blockpos1 = this.pos.south();
      BlockPos blockpos2 = this.pos.west();
      BlockPos blockpos3 = this.pos.east();
