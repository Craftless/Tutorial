...
public class Blocks {
   ...
   public static final Block LAVA = register("lava", new FlowingFluidBlock(Fluids.LAVA, AbstractBlock.Properties.create(Material.LAVA).doesNotBlockMovement().tickRandomly().hardnessAndResistance(100.0F).setLightLevel((p_235418_0_) -> {
      return 15;
   }).noDrops()));
   ...
   public static final Block BROWN_MUSHROOM = register("brown_mushroom", new MushroomBlock(AbstractBlock.Properties.create(Material.PLANTS, MaterialColor.BROWN).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT).setLightLevel((p_235417_0_) -> {
      return 1;
   ...
   public static final Block TORCH = register("torch", new TorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235470_0_) -> {
      return 14;
   }).sound(SoundType.WOOD), ParticleTypes.FLAME));
   public static final Block WALL_TORCH = register("wall_torch", new WallTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235469_0_) -> {
      return 14;
   }).sound(SoundType.WOOD).lootFrom(TORCH), ParticleTypes.FLAME));
   public static final Block FIRE = register("fire", new FireBlock(AbstractBlock.Properties.create(Material.FIRE, MaterialColor.TNT).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235468_0_) -> {
      return 15;
   }).sound(SoundType.CLOTH)));
   public static final Block SOUL_FIRE = register("soul_fire", new SoulFireBlock(AbstractBlock.Properties.create(Material.FIRE, MaterialColor.LIGHT_BLUE).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235467_0_) -> {
      return 10;
   }).sound(SoundType.CLOTH)));
   ...
   public static final Block FARMLAND = register("farmland", new FarmlandBlock(AbstractBlock.Properties.create(Material.EARTH).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.GROUND).setBlocksVision(Blocks::needsPostProcessing)));
   ...
   public static final Block ICE = register("ice", new IceBlock(AbstractBlock.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS).notSolid().setAllowsSpawn((p_235450_0_, p_235450_1_, p_235450_2_, p_235450_3_) -> {
   ...
   public static final Block SOUL_TORCH = register("soul_torch", new TorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235466_0_) -> {
      return 10;
   }).sound(SoundType.WOOD), ParticleTypes.SOUL_FIRE_FLAME));
   public static final Block SOUL_WALL_TORCH = register("soul_wall_torch", new WallTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235465_0_) -> {
      return 10;
   }).sound(SoundType.WOOD).lootFrom(SOUL_TORCH), ParticleTypes.SOUL_FIRE_FLAME));
   public static final Block GLOWSTONE = register("glowstone", new Block(AbstractBlock.Properties.create(Material.GLASS, MaterialColor.SAND).hardnessAndResistance(0.3F).sound(SoundType.GLASS).setLightLevel((p_235464_0_) -> {
      return 15;
   })));
   public static final Block NETHER_PORTAL = register("nether_portal", new NetherPortalBlock(AbstractBlock.Properties.create(Material.PORTAL).doesNotBlockMovement().tickRandomly().hardnessAndResistance(-1.0F).sound(SoundType.GLASS).setLightLevel((p_235463_0_) -> {
      return 11;
   })));
   ...
   public static final Block JACK_O_LANTERN = register("jack_o_lantern", new CarvedPumpkinBlock(AbstractBlock.Properties.create(Material.GOURD, MaterialColor.ADOBE).hardnessAndResistance(1.0F).sound(SoundType.WOOD).setLightLevel((p_235462_0_) -> {
      return 15;
   ...
   public static final Block BREWING_STAND = register("brewing_stand", new BrewingStandBlock(AbstractBlock.Properties.create(Material.IRON).setRequiresTool().hardnessAndResistance(0.5F).setLightLevel((p_235461_0_) -> {
      return 1;
   }).notSolid()));
   ...
   public static final Block END_PORTAL = register("end_portal", new EndPortalBlock(AbstractBlock.Properties.create(Material.PORTAL, MaterialColor.BLACK).doesNotBlockMovement().setLightLevel((p_235460_0_) -> {
      return 15;
   }).hardnessAndResistance(-1.0F, 3600000.0F).noDrops()));
   public static final Block END_PORTAL_FRAME = register("end_portal_frame", new EndPortalFrameBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.GREEN).sound(SoundType.GLASS).setLightLevel((p_235459_0_) -> {
      return 1;
   }).hardnessAndResistance(-1.0F, 3600000.0F).noDrops()));
   ...
   public static final Block DRAGON_EGG = register("dragon_egg", new DragonEggBlock(AbstractBlock.Properties.create(Material.DRAGON_EGG, MaterialColor.BLACK).hardnessAndResistance(3.0F, 9.0F).setLightLevel((p_235458_0_) -> {
      return 1;
   }).notSolid()));
   ...
   public static final Block ENDER_CHEST = register("ender_chest", new EnderChestBlock(AbstractBlock.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(22.5F, 600.0F).setLightLevel((p_235457_0_) -> {
      return 7;
   })));
   ...
   public static final Block BEACON = register("beacon", new BeaconBlock(AbstractBlock.Properties.create(Material.GLASS, MaterialColor.DIAMOND).hardnessAndResistance(3.0F).setLightLevel((p_235456_0_) -> {
      return 15;
   ...
   public static final Block IRON_TRAPDOOR = register("iron_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.IRON).setRequiresTool().hardnessAndResistance(5.0F).sound(SoundType.METAL).notSolid()));
   ...
   public static final Block SEA_LANTERN = register("sea_lantern", new Block(AbstractBlock.Properties.create(Material.GLASS, MaterialColor.QUARTZ).hardnessAndResistance(0.3F).sound(SoundType.GLASS).setLightLevel((p_235455_0_) -> {
      return 15;
   })));
   ...
   public static final Block END_ROD = register("end_rod", new EndRodBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).zeroHardnessAndResistance().setLightLevel((p_235454_0_) -> {
      return 14;
   ...
   public static final Block GRASS_PATH = register("grass_path", new GrassPathBlock(AbstractBlock.Properties.create(Material.EARTH).hardnessAndResistance(0.65F).sound(SoundType.PLANT).setBlocksVision(Blocks::needsPostProcessing)));
   public static final Block END_GATEWAY = register("end_gateway", new EndGatewayBlock(AbstractBlock.Properties.create(Material.PORTAL, MaterialColor.BLACK).doesNotBlockMovement().setLightLevel((p_235453_0_) -> {
      return 15;
   }).hardnessAndResistance(-1.0F, 3600000.0F).noDrops()));
   ...
   public static final Block FROSTED_ICE = register("frosted_ice", new FrostedIceBlock(AbstractBlock.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS).notSolid().setAllowsSpawn((p_235448_0_, p_235448_1_, p_235448_2_, p_235448_3_) -> {
      return p_235448_3_ == EntityType.POLAR_BEAR;
   })));
   public static final Block MAGMA_BLOCK = register("magma_block", new MagmaBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().setLightLevel((p_235452_0_) -> {
      return 3;
   ...
   public static final Block SEA_PICKLE = register("sea_pickle", new SeaPickleBlock(AbstractBlock.Properties.create(Material.OCEAN_PLANT, MaterialColor.GREEN).setLightLevel((p_235451_0_) -> {
   ...
   public static final Block CONDUIT = register("conduit", new ConduitBlock(AbstractBlock.Properties.create(Material.GLASS, MaterialColor.DIAMOND).hardnessAndResistance(3.0F).setLightLevel((p_235449_0_) -> {
      return 15;
   }).notSolid()));
   ...
   public static final Block LANTERN = register("lantern", new LanternBlock(AbstractBlock.Properties.create(Material.IRON).setRequiresTool().hardnessAndResistance(3.5F).sound(SoundType.LANTERN).setLightLevel((p_235447_0_) -> {
      return 15;
   }).notSolid()));
   public static final Block SOUL_LANTERN = register("soul_lantern", new LanternBlock(AbstractBlock.Properties.create(Material.IRON).setRequiresTool().hardnessAndResistance(3.5F).sound(SoundType.LANTERN).setLightLevel((p_235443_0_) -> {
      return 10;
   }).notSolid()));
   ...
   public static final Block WARPED_ROOTS = register("warped_roots", new NetherRootsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.CYAN).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.ROOT)));
   public static final Block NETHER_SPROUTS = register("nether_sprouts", new NetherSproutsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.CYAN).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.NETHER_SPROUT)));
   ...
   public static final Block SHROOMLIGHT = register("shroomlight", new Block(AbstractBlock.Properties.create(Material.ORGANIC, MaterialColor.RED).hardnessAndResistance(1.0F).sound(SoundType.SHROOMLIGHT).setLightLevel((p_235439_0_) -> {
      return 15;
   })));
   ...
   public static final Block CRIMSON_ROOTS = register("crimson_roots", new NetherRootsBlock(AbstractBlock.Properties.create(Material.TALL_PLANTS, MaterialColor.NETHERRACK).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.ROOT)));
   ...
   public static final Block CRIMSON_SLAB = register("crimson_slab", new SlabBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_SLAB = register("warped_slab", new SlabBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
   public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_FENCE = register("crimson_fence", new FenceBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_FENCE = register("warped_fence", new FenceBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).hardnessAndResistance(3.0F).sound(SoundType.WOOD).notSolid()));
   public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new FenceGateBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new FenceGateBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
   ...
   public static final Block CRIMSON_SIGN = register("crimson_sign", new StandingSignBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.NETHERRACK).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD), WoodType.CRIMSON));
   public static final Block WARPED_SIGN = register("warped_sign", new StandingSignBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.CYAN).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD), WoodType.WARPED));
   public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new WallSignBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(CRIMSON_SIGN), WoodType.CRIMSON));
   public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new WallSignBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(WARPED_SIGN), WoodType.WARPED));
   ...
   public static final Block CRYING_OBSIDIAN = register("crying_obsidian", new CryingObsidianBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(50.0F, 1200.0F).setLightLevel((p_235435_0_) -> {
      return 10;
   })));
   public static final Block RESPAWN_ANCHOR = register("respawn_anchor", new RespawnAnchorBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(50.0F, 1200.0F).setLightLevel((p_235425_0_) -> {
   ...
   private static BedBlock createBedFromColor(DyeColor color) {
      return new BedBlock(color, AbstractBlock.Properties.create(Material.WOOL, (p_235424_1_) -> {
         return p_235424_1_.get(BedBlock.PART) == BedPart.FOOT ? color.getMapColor() : MaterialColor.WOOL;
   ...
   private static Block createRotatableNetherBlock(MaterialColor materialColor) {
      return new RotatedPillarBlock(AbstractBlock.Properties.create(Material.NETHER_WOOD, (p_235429_1_) -> {
