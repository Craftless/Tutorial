...
public class NyliumBlock extends Block implements IGrowable {
   ...
   public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
      ...
      if (blockstate.isIn(Blocks.CRIMSON_NYLIUM)) {
         NetherVegetationFeature.func_236325_a_(worldIn, rand, blockpos, DefaultBiomeFeatures.CRIMSON_ROOTS_FEATURE_CONFIG, 3, 1);
      } else if (blockstate.isIn(Blocks.WARPED_NYLIUM)) {
         NetherVegetationFeature.func_236325_a_(worldIn, rand, blockpos, DefaultBiomeFeatures.WARPED_ROOTS, 3, 1);
         NetherVegetationFeature.func_236325_a_(worldIn, rand, blockpos, DefaultBiomeFeatures.NETHER_SPROUTS, 3, 1);
         if (rand.nextInt(8) == 0) {
