...
public class JigsawBlock extends Block implements ITileEntityProvider {
   ...
   public static boolean func_220171_a(Template.BlockInfo info, Template.BlockInfo info2) {
      Direction direction = func_235508_h_(info.state);
      Direction direction1 = func_235508_h_(info2.state);
      Direction direction2 = func_235509_l_(info.state);
      Direction direction3 = func_235509_l_(info2.state);
   ...
   public static Direction func_235508_h_(BlockState state) {
      return state.get(ORIENTATION).func_239642_b_();
   }

   public static Direction func_235509_l_(BlockState state) {
