...
public abstract class World extends net.minecraftforge.common.capabilities.CapabilityProvider<World> implements IWorld, AutoCloseable, net.minecraftforge.common.extensions.IForgeWorld {
   ...
   public static final Codec<RegistryKey<World>> field_234917_f_ = ResourceLocation.RESOURCE_LOCATION_CODEC.xmap(RegistryKey.func_240902_a_(Registry.WORLD_KEY), RegistryKey::func_240901_a_);
   public static final RegistryKey<World> field_234918_g_ = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("overworld"));
   public static final RegistryKey<World> field_234919_h_ = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("the_nether"));
   public static final RegistryKey<World> field_234920_i_ = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("the_end"));
   ...
   public double func_234928_a_(BlockPos p_234928_1_, double p_234928_2_) {
      BlockPos.Mutable blockpos$mutable = p_234928_1_.toMutable();
   ...
   public Explosion createExplosion(@Nullable Entity entityIn, double xIn, double yIn, double zIn, float explosionRadius, Explosion.Mode modeIn) {
      return this.createExplosion(entityIn, (DamageSource)null, (IExplosionContext)null, xIn, yIn, zIn, explosionRadius, false, modeIn);
   }
   ...
   public Explosion createExplosion(@Nullable Entity entityIn, double xIn, double yIn, double zIn, float explosionRadius, boolean causesFire, Explosion.Mode modeIn) {
      return this.createExplosion(entityIn, (DamageSource)null, (IExplosionContext)null, xIn, yIn, zIn, explosionRadius, causesFire, modeIn);
   }
