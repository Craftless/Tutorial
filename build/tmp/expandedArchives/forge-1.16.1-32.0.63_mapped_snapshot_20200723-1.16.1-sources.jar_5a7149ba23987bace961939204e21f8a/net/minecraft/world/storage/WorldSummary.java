...
public class WorldSummary implements Comparable<WorldSummary> {
   ...
   public String getDisplayName() {
      return StringUtils.isEmpty(this.field_237307_a_.getWorldName()) ? this.fileName : this.field_237307_a_.getWorldName();
   }
   ...
   public GameType getEnumGameType() {
      return this.field_237307_a_.getGameType();
   }

   @OnlyIn(Dist.CLIENT)
   public boolean isHardcoreModeEnabled() {
      return this.field_237307_a_.isHardcoreEnabled();
   }
   ...
   public boolean getCheatsEnabled() {
      return this.field_237307_a_.isCommandsAllowed();
   }
