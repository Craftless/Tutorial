...
public class ChunkHolder {
   ...
   public void func_241819_a(int p_241819_1_, int p_241819_2_, int p_241819_3_) {
      ...
      if (chunk != null) {
         this.blockChangeMask |= 1 << (p_241819_2_ >> 4);
   ...
   public void sendChanges(Chunk chunkIn) {
      if (this.changedBlocks != 0 || this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0) {
         ...
         if (this.changedBlocks < net.minecraftforge.common.ForgeConfig.SERVER.clumpingThreshold.get() && (this.skyLightChangeMask != 0 || this.blockLightChangeMask != 0)) {
            this.sendToTracking(new SUpdateLightPacket(chunkIn.getPos(), this.lightManager, this.skyLightChangeMask, this.blockLightChangeMask, false), true);
            this.skyLightChangeMask = 0;
            this.blockLightChangeMask = 0;
         }

         if (this.changedBlocks == 1) {
            int i = (this.changedBlockPositions[0] >> 12 & 15) + this.pos.x * 16;
            int j = this.changedBlockPositions[0] & 255;
            ...
            this.sendToTracking(new SChunkDataPacket(chunkIn, this.blockChangeMask, false), false);
            ...
            for(int l = 0; l < this.changedBlocks; ++l) {
               int i1 = (this.changedBlockPositions[l] >> 12 & 15) + this.pos.x * 16;
               int j1 = this.changedBlockPositions[l] & 255;
               int k1 = (this.changedBlockPositions[l] >> 8 & 15) + this.pos.z * 16;
