...
public interface IStructurePieceType {
   ...
   IStructurePieceType BASTION_REMNANT = register(BastionRemnantsPieces.Bastion::new, "BastionRemnant");
   IStructurePieceType RUNTIME = register(JigsawTileEntity.RuntimePiece::new, "Runtime");
