...
public class EndCityStructure extends Structure<NoFeatureConfig> {
   ...
   public static class Start extends StructureStart<NoFeatureConfig> {
      ...
      public void func_230364_a_(ChunkGenerator p_230364_1_, TemplateManager p_230364_2_, int p_230364_3_, int p_230364_4_, Biome p_230364_5_, NoFeatureConfig p_230364_6_) {
         ...
         int i = EndCityStructure.getYPosForStructure(p_230364_3_, p_230364_4_, p_230364_1_);
         if (i >= 60) {
            BlockPos blockpos = new BlockPos(p_230364_3_ * 16 + 8, i, p_230364_4_ * 16 + 8);
            EndCityPieces.startHouseTower(p_230364_2_, blockpos, rotation, this.components, this.rand);
