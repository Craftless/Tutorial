...
public class BlockWithContextConfig implements IFeatureConfig {
   public static final Codec<BlockWithContextConfig> field_236636_a_ = RecordCodecBuilder.create((p_236638_0_) -> {
      return p_236638_0_.group(BlockState.BLOCKSTATE_CODEC.fieldOf("to_place").forGetter((p_236641_0_) -> {
         return p_236641_0_.toPlace;
      }), BlockState.BLOCKSTATE_CODEC.listOf().fieldOf("place_on").forGetter((p_236640_0_) -> {
         return p_236640_0_.placeOn;
      }), BlockState.BLOCKSTATE_CODEC.listOf().fieldOf("place_in").forGetter((p_236639_0_) -> {
         return p_236639_0_.placeIn;
      }), BlockState.BLOCKSTATE_CODEC.listOf().fieldOf("place_under").forGetter((p_236637_0_) -> {
