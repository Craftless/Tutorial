...
public class BlockStateFeatureConfig implements IFeatureConfig {
   public static final Codec<BlockStateFeatureConfig> field_236455_a_ = BlockState.BLOCKSTATE_CODEC.fieldOf("state").xmap(BlockStateFeatureConfig::new, (p_236456_0_) -> {
