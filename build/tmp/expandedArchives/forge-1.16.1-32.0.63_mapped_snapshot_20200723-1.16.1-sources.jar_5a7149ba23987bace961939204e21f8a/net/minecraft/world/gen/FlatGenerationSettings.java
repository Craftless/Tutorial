...
public class FlatGenerationSettings {
   ...
   private static final Map<Structure<?>, StructureFeature<?, ?>> STRUCTURES = Util.make(Maps.newHashMap(), (p_236940_0_) -> {
      p_236940_0_.put(Structure.field_236367_c_, DefaultBiomeFeatures.MINESHAFT_NORMAL);
      p_236940_0_.put(Structure.field_236381_q_, DefaultBiomeFeatures.VILLAGE_PLAINS);
      p_236940_0_.put(Structure.field_236375_k_, DefaultBiomeFeatures.STRONGHOLD);
      p_236940_0_.put(Structure.field_236374_j_, DefaultBiomeFeatures.SWAMP_HUT);
      p_236940_0_.put(Structure.field_236370_f_, DefaultBiomeFeatures.DESERT_PYRAMID);
      p_236940_0_.put(Structure.field_236369_e_, DefaultBiomeFeatures.JUNGLE_PYRAMID);
      p_236940_0_.put(Structure.field_236371_g_, DefaultBiomeFeatures.IGLOO);
      p_236940_0_.put(Structure.field_236377_m_, DefaultBiomeFeatures.OCEAN_MONUMENT_COLD);
      p_236940_0_.put(Structure.field_236373_i_, DefaultBiomeFeatures.RUINED_PORTAL);
      p_236940_0_.put(Structure.field_236376_l_, DefaultBiomeFeatures.MONUMENT);
      p_236940_0_.put(Structure.field_236379_o_, DefaultBiomeFeatures.END_CITY);
      p_236940_0_.put(Structure.field_236368_d_, DefaultBiomeFeatures.MANSION);
      p_236940_0_.put(Structure.field_236378_n_, DefaultBiomeFeatures.FORTRESS);
      p_236940_0_.put(Structure.field_236366_b_, DefaultBiomeFeatures.PILLAGER_OUTPOST);
      p_236940_0_.put(Structure.field_236372_h_, DefaultBiomeFeatures.RUINED_PORTAL_STANDARD);
      p_236940_0_.put(Structure.field_236383_s_, DefaultBiomeFeatures.BASTION_REMNANT);
   });
