...
public class HugeFungusConfig implements IFeatureConfig {
   public static final Codec<HugeFungusConfig> field_236298_a_ = RecordCodecBuilder.create((p_236309_0_) -> {
      return p_236309_0_.group(BlockState.BLOCKSTATE_CODEC.fieldOf("valid_base_block").forGetter((p_236313_0_) -> {
         return p_236313_0_.field_236303_f_;
      }), BlockState.BLOCKSTATE_CODEC.fieldOf("stem_state").forGetter((p_236312_0_) -> {
         return p_236312_0_.field_236304_g_;
      }), BlockState.BLOCKSTATE_CODEC.fieldOf("hat_state").forGetter((p_236311_0_) -> {
         return p_236311_0_.field_236305_h_;
      }), BlockState.BLOCKSTATE_CODEC.fieldOf("decor_state").forGetter((p_236310_0_) -> {
         return p_236310_0_.field_236306_i_;
      }), Codec.BOOL.fieldOf("planted").withDefault(false).forGetter((p_236308_0_) -> {
