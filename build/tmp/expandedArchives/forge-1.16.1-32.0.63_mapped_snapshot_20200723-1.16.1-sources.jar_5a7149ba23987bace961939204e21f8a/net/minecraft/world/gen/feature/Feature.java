...
public abstract class Feature<FC extends IFeatureConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Feature<?>> {
   ...
   public static final Feature<BaseTreeFeatureConfig> field_236291_c_ = register("tree", new TreeFeature(BaseTreeFeatureConfig.CODEC_BASE_TREE_FEATURE_CONFIG));
   ...
   public static final Feature<BlockBlobConfig> FOREST_ROCK = register("forest_rock", new BlockBlobFeature(BlockBlobConfig.field_236449_a_));
   ...
   public static final Feature<FeatureRadiusConfig> ICE_PATCH = register("ice_patch", new IcePathFeature(FeatureRadiusConfig.field_236526_a_));
   ...
   public static final Feature<SeaGrassConfig> SEAGRASS = register("seagrass", new SeaGrassFeature(SeaGrassConfig.field_236630_a_));
   ...
   public static final Feature<CountConfig> SEA_PICKLE = register("sea_pickle", new SeaPickleFeature(CountConfig.field_236483_a_));
   ...
   public static final Feature<NetherackBlobReplacementFeature> field_236287_R_ = register("netherrack_replace_blobs", new NetherackBlobReplacementStructure(NetherackBlobReplacementFeature.field_236608_a_));
   ...
   public static final Feature<MultipleWithChanceRandomFeatureConfig> RANDOM_RANDOM_SELECTOR = register("random_random_selector", new MultipleRandomFeature(MultipleWithChanceRandomFeatureConfig.field_236600_a_));
   ...
   public static final Feature<DecoratedFeatureConfig> DECORATED_FLOWER = register("decorated_flower", new DecoratedFlowerFeature(DecoratedFeatureConfig.field_236491_a_));
