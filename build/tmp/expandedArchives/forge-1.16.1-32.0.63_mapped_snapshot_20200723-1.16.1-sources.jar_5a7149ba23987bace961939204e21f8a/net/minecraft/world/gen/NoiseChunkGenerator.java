...
public final class NoiseChunkGenerator extends ChunkGenerator {
   public static final Codec<NoiseChunkGenerator> field_236079_d_ = RecordCodecBuilder.create((p_236091_0_) -> {
      return p_236091_0_.group(BiomeProvider.PROVIDER_CODEC.fieldOf("biome_source").forGetter((p_236096_0_) -> {
   ...
   public NoiseChunkGenerator(BiomeProvider p_i231903_1_, long p_i231903_2_, DimensionSettings p_i231903_4_) {
      this(p_i231903_1_, p_i231903_1_, p_i231903_2_, p_i231903_4_);
   }

   private NoiseChunkGenerator(BiomeProvider p_i231904_1_, BiomeProvider p_i231904_2_, long p_i231904_3_, DimensionSettings p_i231904_5_) {
      super(p_i231904_1_, p_i231904_2_, p_i231904_5_.getStructures(), p_i231904_3_);
      this.field_236084_w_ = p_i231904_3_;
      this.field_236080_h_ = p_i231904_5_;
      NoiseSettings noisesettings = p_i231904_5_.getNoise();
      ...
      this.defaultBlock = p_i231904_5_.getDefaultBlock();
      this.defaultFluid = p_i231904_5_.getDefaultFluid();
   ...
   private void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
      NoiseSettings noisesettings = this.field_236080_h_.getNoise();
      double d0;
      double d1;
