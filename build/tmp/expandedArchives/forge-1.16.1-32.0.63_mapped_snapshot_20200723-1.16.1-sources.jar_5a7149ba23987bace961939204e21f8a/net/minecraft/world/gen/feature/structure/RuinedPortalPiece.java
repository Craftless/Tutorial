...
public class RuinedPortalPiece extends TemplateStructurePiece {
   ...
   private boolean func_237010_a_(IWorld p_237010_1_, BlockPos p_237010_2_) {
      ...
      return !blockstate.isIn(Blocks.AIR) && !blockstate.isIn(Blocks.OBSIDIAN) && (this.field_237007_h_ == RuinedPortalPiece.Location.IN_NETHER || !blockstate.isIn(Blocks.LAVA));
   }
