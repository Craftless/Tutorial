...
public class DebugChunkGenerator extends ChunkGenerator {
   public static final DebugChunkGenerator field_236065_d_ = new DebugChunkGenerator();
   public static final Codec<DebugChunkGenerator> field_236066_e_ = MapCodec.of(Encoder.empty(), Decoder.unit(() -> {
      return field_236065_d_;
   })).stable().codec();
