...
public class Template {
   ...
   public void func_237152_b_(IWorld p_237152_1_, BlockPos p_237152_2_, PlacementSettings p_237152_3_, Random p_237152_4_) {
      this.func_237146_a_(p_237152_1_, p_237152_2_, p_237152_2_, p_237152_3_, p_237152_4_, 2);
   }

   public boolean func_237146_a_(IWorld p_237146_1_, BlockPos p_237146_2_, BlockPos p_237146_3_, PlacementSettings p_237146_4_, Random p_237146_5_, int p_237146_6_) {
      if (this.blocks.isEmpty()) {
         return false;
      } else {
   ...
   public static List<Template.EntityInfo> processEntityInfos(@Nullable Template template, IWorld worldIn, BlockPos offsetPos, PlacementSettings placementSettingsIn, List<Template.EntityInfo> blockInfos) {
      ...
      for(Template.EntityInfo entityInfo : blockInfos) {
         Vector3d pos = transformedVec3d(placementSettingsIn, entityInfo.pos).add(Vector3d.copy(offsetPos));
   ...
   private void addEntitiesToWorld(IWorld p_237143_1_, BlockPos p_237143_2_, PlacementSettings placementIn) {
      for(Template.EntityInfo template$entityinfo : processEntityInfos(this, p_237143_1_, p_237143_2_, placementIn, this.entities)) {
         ...
         if (placementIn.getBoundingBox() == null || placementIn.getBoundingBox().isVecInside(blockpos)) {
            ...
            loadEntity(p_237143_1_, compoundnbt).ifPresent((p_237147_6_) -> {
               float f = p_237147_6_.getMirroredYaw(placementIn.getMirror());
               f = f + (p_237147_6_.rotationYaw - p_237147_6_.getRotatedYaw(placementIn.getRotation()));
               p_237147_6_.setLocationAndAngles(vector3d1.x, vector3d1.y, vector3d1.z, f, p_237147_6_.rotationPitch);
               if (placementIn.func_237134_m_() && p_237147_6_ instanceof MobEntity) {
                  ((MobEntity)p_237147_6_).onInitialSpawn(p_237143_1_, p_237143_1_.getDifficultyForLocation(new BlockPos(vector3d1)), SpawnReason.STRUCTURE, (ILivingEntityData)null, compoundnbt);
               }

               p_237143_1_.addEntity(p_237147_6_);
            });
         }
      }
