...
public abstract class ChunkGenerator {
      ...
      if (this.field_235951_f_.isEmpty()) {
         ...
         if (structurespreadsettings != null && structurespreadsettings.func_236663_c_() != 0) {
            ...
            for(int l = 0; l < l1; ++l) {
               ...
               BlockPos blockpos = this.biomeProvider.func_225531_a_((i1 << 4) + 8, 0, (j1 << 4) + 8, 112, list, random);
               if (blockpos != null) {
                  i1 = blockpos.getX() >> 4;
                  j1 = blockpos.getZ() >> 4;
               }
   ...
   public void generateBiomes(IChunk chunkIn) {
      ...
      ((ChunkPrimer)chunkIn).setBiomes(new BiomeContainer(chunkpos, this.field_235949_c_));
   }
   ...
   public BlockPos func_235956_a_(ServerWorld p_235956_1_, Structure<?> p_235956_2_, BlockPos p_235956_3_, int p_235956_4_, boolean p_235956_5_) {
      if (!this.biomeProvider.hasStructure(p_235956_2_)) {
         ...
         return p_235956_2_.func_236388_a_(p_235956_1_, p_235956_1_.func_241112_a_(), p_235956_3_, p_235956_4_, p_235956_5_, p_235956_1_.getSeed(), this.settings.func_236197_a_(p_235956_2_));
      }
   }
   ...
   public void func_230351_a_(WorldGenRegion p_230351_1_, StructureManager p_230351_2_) {
      ...
      for(GenerationStage.Decoration generationstage$decoration : GenerationStage.Decoration.values()) {
         try {
            biome.func_235061_a_(generationstage$decoration, p_230351_2_, this, p_230351_1_, i1, sharedseedrandom, blockpos);
   ...
   public List<Biome.SpawnListEntry> func_230353_a_(Biome p_230353_1_, StructureManager p_230353_2_, EntityClassification p_230353_3_, BlockPos p_230353_4_) {
      return p_230353_1_.getSpawns(p_230353_3_);
   }

   public void func_235954_a_(StructureManager p_235954_1_, IChunk p_235954_2_, TemplateManager p_235954_3_, long p_235954_4_) {
      ChunkPos chunkpos = p_235954_2_.getPos();
      Biome biome = this.biomeProvider.getNoiseBiome((chunkpos.x << 2) + 2, 0, (chunkpos.z << 2) + 2);
      this.func_235955_a_(DefaultBiomeFeatures.STRONGHOLD, p_235954_1_, p_235954_2_, p_235954_3_, p_235954_4_, chunkpos, biome);

      for(StructureFeature<?, ?> structurefeature : biome.func_235077_g_()) {
         this.func_235955_a_(structurefeature, p_235954_1_, p_235954_2_, p_235954_3_, p_235954_4_, chunkpos, biome);
      }

   }

   private void func_235955_a_(StructureFeature<?, ?> p_235955_1_, StructureManager p_235955_2_, IChunk p_235955_3_, TemplateManager p_235955_4_, long p_235955_5_, ChunkPos p_235955_7_, Biome p_235955_8_) {
      StructureStart<?> structurestart = p_235955_2_.func_235013_a_(SectionPos.from(p_235955_3_.getPos(), 0), p_235955_1_.field_236268_b_, p_235955_3_);
      int i = structurestart != null ? structurestart.getRefCount() : 0;
      StructureStart<?> structurestart1 = p_235955_1_.func_236270_a_(this, this.biomeProvider, p_235955_4_, p_235955_5_, p_235955_7_, p_235955_8_, i, this.settings.func_236197_a_(p_235955_1_.field_236268_b_));
      p_235955_2_.func_235014_a_(SectionPos.from(p_235955_3_.getPos(), 0), p_235955_1_.field_236268_b_, structurestart1, p_235955_3_);
   }
