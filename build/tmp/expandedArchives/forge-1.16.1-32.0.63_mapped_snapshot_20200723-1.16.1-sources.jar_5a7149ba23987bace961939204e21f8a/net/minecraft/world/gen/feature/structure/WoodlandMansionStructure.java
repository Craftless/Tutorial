...
public class WoodlandMansionStructure extends Structure<NoFeatureConfig> {
   ...
   public static class Start extends StructureStart<NoFeatureConfig> {
      ...
      public void func_230364_a_(ChunkGenerator p_230364_1_, TemplateManager p_230364_2_, int p_230364_3_, int p_230364_4_, Biome p_230364_5_, NoFeatureConfig p_230364_6_) {
         ...
         int k = (p_230364_3_ << 4) + 7;
         int l = (p_230364_4_ << 4) + 7;
         int i1 = p_230364_1_.getNoiseHeightMinusOne(k, l, Heightmap.Type.WORLD_SURFACE_WG);
         int j1 = p_230364_1_.getNoiseHeightMinusOne(k, l + j, Heightmap.Type.WORLD_SURFACE_WG);
         int k1 = p_230364_1_.getNoiseHeightMinusOne(k + i, l, Heightmap.Type.WORLD_SURFACE_WG);
         int l1 = p_230364_1_.getNoiseHeightMinusOne(k + i, l + j, Heightmap.Type.WORLD_SURFACE_WG);
         int i2 = Math.min(Math.min(i1, j1), Math.min(k1, l1));
         if (i2 >= 60) {
            BlockPos blockpos = new BlockPos(p_230364_3_ * 16 + 8, i2 + 1, p_230364_4_ * 16 + 8);
            List<WoodlandMansionPieces.MansionTemplate> list = Lists.newLinkedList();
            WoodlandMansionPieces.generateMansion(p_230364_2_, blockpos, rotation, list, this.rand);
