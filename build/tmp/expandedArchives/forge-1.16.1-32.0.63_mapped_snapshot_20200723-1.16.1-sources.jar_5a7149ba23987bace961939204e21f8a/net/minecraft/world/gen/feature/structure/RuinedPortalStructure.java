...
public class RuinedPortalStructure extends Structure<RuinedPortalFeature> {
   ...
   public static class Start extends StructureStart<RuinedPortalFeature> {
      ...
      public void func_230364_a_(ChunkGenerator p_230364_1_, TemplateManager p_230364_2_, int p_230364_3_, int p_230364_4_, Biome p_230364_5_, RuinedPortalFeature p_230364_6_) {
         ...
         if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.DESERT) {
         ...
         } else if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.JUNGLE) {
         ...
         } else if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.SWAMP) {
            ruinedportalpiece$location = RuinedPortalPiece.Location.ON_OCEAN_FLOOR;
            ruinedportalpiece$serializer.field_237027_d_ = false;
            ruinedportalpiece$serializer.field_237026_c_ = 0.5F;
            ruinedportalpiece$serializer.field_237029_f_ = true;
         } else if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.MOUNTAIN) {
         ...
         } else if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.OCEAN) {
            ruinedportalpiece$location = RuinedPortalPiece.Location.ON_OCEAN_FLOOR;
            ruinedportalpiece$serializer.field_237027_d_ = false;
            ruinedportalpiece$serializer.field_237026_c_ = 0.8F;
         } else if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.NETHER) {
         ...
         Template template = p_230364_2_.getTemplateDefaulted(resourcelocation);
         ...
         BlockPos blockpos1 = (new ChunkPos(p_230364_3_, p_230364_4_)).asBlockPos();
         ...
         int i = vector3i.getX();
         int j = vector3i.getZ();
         int k = p_230364_1_.getHeight(i, j, RuinedPortalPiece.func_237013_a_(ruinedportalpiece$location)) - 1;
         int l = RuinedPortalStructure.func_236339_b_(this.rand, p_230364_1_, ruinedportalpiece$location, ruinedportalpiece$serializer.field_237027_d_, k, mutableboundingbox.getYSize(), mutableboundingbox);
         BlockPos blockpos2 = new BlockPos(blockpos1.getX(), l, blockpos1.getZ());
         if (p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.MOUNTAIN || p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.OCEAN || p_230364_6_.field_236628_b_ == RuinedPortalStructure.Location.STANDARD) {
            ruinedportalpiece$serializer.field_237025_b_ = RuinedPortalStructure.func_236337_b_(blockpos2, p_230364_5_);
         }
