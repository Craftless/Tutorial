...
public class OreFeatureConfig implements IFeatureConfig {
   ...
   public static enum FillerBlockType implements IStringSerializable, net.minecraftforge.common.IExtensibleEnum {
      ...
      public static final Codec<OreFeatureConfig.FillerBlockType> field_236571_d_ = IStringSerializable.createEnumCodec(OreFeatureConfig.FillerBlockType::values, OreFeatureConfig.FillerBlockType::byName);
