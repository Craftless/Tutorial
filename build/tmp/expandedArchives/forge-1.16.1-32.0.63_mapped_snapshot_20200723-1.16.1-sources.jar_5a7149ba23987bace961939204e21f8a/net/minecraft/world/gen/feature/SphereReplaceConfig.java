...
public class SphereReplaceConfig implements IFeatureConfig {
   public static final Codec<SphereReplaceConfig> field_236516_a_ = RecordCodecBuilder.create((p_236518_0_) -> {
      return p_236518_0_.group(BlockState.BLOCKSTATE_CODEC.fieldOf("state").forGetter((p_236521_0_) -> {
      ...
      }), BlockState.BLOCKSTATE_CODEC.listOf().fieldOf("targets").forGetter((p_236517_0_) -> {
