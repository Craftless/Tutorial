...
public class DragonFightManager {
   ...
   private void generateGateway(BlockPos pos) {
      ...
      Feature.END_GATEWAY.withConfiguration(EndGatewayConfig.func_214698_a()).func_236265_a_(this.world, this.world.func_241112_a_(), this.world.getChunkProvider().getChunkGenerator(), new Random(), pos);
   }
