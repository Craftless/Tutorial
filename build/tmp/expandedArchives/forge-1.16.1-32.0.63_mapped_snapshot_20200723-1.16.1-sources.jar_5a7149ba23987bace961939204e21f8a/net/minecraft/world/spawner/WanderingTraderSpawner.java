...
public class WanderingTraderSpawner implements ISpecialSpawner {
   ...
   private boolean func_234562_a_(ServerWorld p_234562_1_) {
      ...
      if (playerentity == null) {
         ...
         if (blockpos2 != null && this.func_234560_a_(p_234562_1_, blockpos2)) {
            if (p_234562_1_.getBiome(blockpos2) == Biomes.THE_VOID) {
               return false;
            }
   ...
   private void func_221243_a(WanderingTraderEntity p_221243_1_, int p_221243_2_) {
      BlockPos blockpos = this.func_234561_a_(p_221243_1_.world, p_221243_1_.getPosition(), p_221243_2_);
      if (blockpos != null) {
         TraderLlamaEntity traderllamaentity = EntityType.TRADER_LLAMA.spawn(p_221243_1_.world, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, blockpos, SpawnReason.EVENT, false, false);
