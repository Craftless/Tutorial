...
public class Explosion {
   ...
   public Explosion(World p_i231610_1_, @Nullable Entity p_i231610_2_, @Nullable DamageSource p_i231610_3_, @Nullable IExplosionContext p_i231610_4_, double p_i231610_5_, double p_i231610_7_, double p_i231610_9_, float p_i231610_11_, boolean p_i231610_12_, Explosion.Mode p_i231610_13_) {
   ...
   private IExplosionContext func_234894_a_(@Nullable Entity p_234894_1_) {
      return (IExplosionContext)(p_234894_1_ == null ? DefaultExplosionContext.INSTANCE : new EntityExplosionContext(p_234894_1_));
   }
