...
public class SoulSandBiome extends Biome {
   protected SoulSandBiome() {
      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.field_237190_ae_, SurfaceBuilder.field_237184_N_).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(1787717).setParticle(new ParticleEffectAmbience(ParticleTypes.ASH, 0.00625F)).setAmbientSound(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_LOOP).setMoodSound(new MoodSoundAmbience(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_MOOD, 6000, 8, 2.0D)).setAdditionsSound(new SoundAdditionsAmbience(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_ADDITIONS, 0.0111D)).setMusic(BackgroundMusicTracks.func_232677_a_(SoundEvents.MUSIC_NETHER_SOUL_SAND_VALLEY)).build()).parent((String)null).func_235098_a_(ImmutableList.of(new Biome.Attributes(0.0F, -0.5F, 0.0F, 0.0F, 0.0F))));
