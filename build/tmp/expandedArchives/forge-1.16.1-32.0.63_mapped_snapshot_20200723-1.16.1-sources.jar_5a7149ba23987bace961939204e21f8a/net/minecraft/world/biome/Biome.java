...
public class Biome extends net.minecraftforge.registries.ForgeRegistryEntry<Biome> {
   ...
   public static final Codec<Biome> field_235051_b_ = RecordCodecBuilder.create((p_235064_0_) -> {
      return p_235064_0_.group(Biome.RainType.RAIN_TYPE_CODEC.fieldOf("precipitation").forGetter((p_235088_0_) -> {
      ...
      }), Codec.simpleMap(GenerationStage.Carving.field_236074_c_, ConfiguredCarver.field_236235_a_.listOf().promotePartial(Util.func_240982_a_("Carver: ", LOGGER::error)), IStringSerializable.createKeyable(GenerationStage.Carving.values())).fieldOf("carvers").forGetter((p_235078_0_) -> {
         return p_235078_0_.carvers;
      }), Codec.simpleMap(GenerationStage.Decoration.field_236076_k_, ConfiguredFeature.field_236264_b_.listOf().promotePartial(Util.func_240982_a_("Feature: ", LOGGER::error)), IStringSerializable.createKeyable(GenerationStage.Decoration.values())).fieldOf("features").forGetter((p_235076_0_) -> {
      ...
      }), Codec.simpleMap(EntityClassification.CLASSIFICATION_CODEC, Biome.SpawnListEntry.SPAWN_LIST_ENTRY_CODEC.listOf().promotePartial(Util.func_240982_a_("Spawn data: ", LOGGER::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((p_235073_0_) -> {
   ...
   public static enum RainType implements IStringSerializable {
      ...
      public static final Codec<Biome.RainType> RAIN_TYPE_CODEC = IStringSerializable.createEnumCodec(Biome.RainType::values, Biome.RainType::getRainType);
