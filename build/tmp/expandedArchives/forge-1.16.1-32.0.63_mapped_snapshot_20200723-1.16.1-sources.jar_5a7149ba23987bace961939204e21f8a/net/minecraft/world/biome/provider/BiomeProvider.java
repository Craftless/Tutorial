...
public abstract class BiomeProvider implements BiomeManager.IBiomeReader {
   public static final Codec<BiomeProvider> PROVIDER_CODEC = Registry.BIOME_PROVIDER_CODEC.dispatchStable(BiomeProvider::func_230319_a_, Function.identity());
      ...
      for(int k1 = j1; k1 <= k; k1 += p_230321_5_) {
         for(int l1 = -k1; l1 <= k1; l1 += p_230321_5_) {
            ...
            for(int i2 = -k1; i2 <= k1; i2 += p_230321_5_) {
               ...
               int k2 = i + i2;
               int j2 = j + l1;
               if (p_230321_6_.contains(this.getNoiseBiome(k2, l, j2))) {
   ...
   static {
      ...
      Registry.register(Registry.BIOME_PROVIDER_CODEC, "checkerboard", CheckerboardBiomeProvider.field_235255_e_);
      Registry.register(Registry.BIOME_PROVIDER_CODEC, "vanilla_layered", OverworldBiomeProvider.field_235297_e_);
      Registry.register(Registry.BIOME_PROVIDER_CODEC, "the_end", EndBiomeProvider.field_235314_e_);
   }
}