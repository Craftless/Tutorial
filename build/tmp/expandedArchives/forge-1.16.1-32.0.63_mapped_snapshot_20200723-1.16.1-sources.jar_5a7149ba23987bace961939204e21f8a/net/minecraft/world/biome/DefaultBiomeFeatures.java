...
public class DefaultBiomeFeatures {
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> PILLAGER_OUTPOST = Structure.field_236366_b_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> MANSION = Structure.field_236368_d_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> JUNGLE_PYRAMID = Structure.field_236369_e_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> DESERT_PYRAMID = Structure.field_236370_f_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> IGLOO = Structure.field_236371_g_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   ...
   public static final StructureFeature<ShipwreckConfig, ? extends Structure<ShipwreckConfig>> SHIPWRECK = Structure.field_236373_i_.func_236391_a_(new ShipwreckConfig(true));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> SWAMP_HUT = Structure.field_236374_j_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> MONUMENT = Structure.field_236376_l_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<OceanRuinConfig, ? extends Structure<OceanRuinConfig>> OCEAN_MONUMENT_COLD = Structure.field_236377_m_.func_236391_a_(new OceanRuinConfig(OceanRuinStructure.Type.COLD, 0.3F, 0.9F));
   public static final StructureFeature<OceanRuinConfig, ? extends Structure<OceanRuinConfig>> OCEAN_MONUMENT_WARM = Structure.field_236377_m_.func_236391_a_(new OceanRuinConfig(OceanRuinStructure.Type.WARM, 0.3F, 0.9F));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> FORTRESS = Structure.field_236378_n_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> NETHER_FOSSIL = Structure.field_236382_r_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> END_CITY = Structure.field_236379_o_.func_236391_a_(NoFeatureConfig.field_236559_b_);
   ...
   public static final StructureFeature<BastionRemnantConfig, ? extends Structure<BastionRemnantConfig>> BASTION_REMNANT = Structure.field_236383_s_.func_236391_a_(new BastionRemnantConfig(BastionRemnantsPieces.field_236257_a_));
   ...
   public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> VILLAGE_DESERT = Structure.field_236381_q_.func_236391_a_(new VillageConfig(new ResourceLocation("village/desert/town_centers"), 6));
   public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> VILLAGE_SAVANNA = Structure.field_236381_q_.func_236391_a_(new VillageConfig(new ResourceLocation("village/savanna/town_centers"), 6));
   public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> VILLAGE_SNOWY = Structure.field_236381_q_.func_236391_a_(new VillageConfig(new ResourceLocation("village/snowy/town_centers"), 6));
   public static final StructureFeature<VillageConfig, ? extends Structure<VillageConfig>> VILLAGE_TAIGA = Structure.field_236381_q_.func_236391_a_(new VillageConfig(new ResourceLocation("village/taiga/town_centers"), 6));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_STANDARD = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.STANDARD));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_DESERT = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.DESERT));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_JUNGLE = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.JUNGLE));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_SWAMP = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.SWAMP));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_MOUNTAIN = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.MOUNTAIN));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_OCEAN = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.OCEAN));
   public static final StructureFeature<RuinedPortalFeature, ? extends Structure<RuinedPortalFeature>> RUINED_PORTAL_NETHER = Structure.field_236372_h_.func_236391_a_(new RuinedPortalFeature(RuinedPortalStructure.Location.NETHER));
   ...
   public static final BaseTreeFeatureConfig OAK_TREE_WITH_BEEHIVES_CONFIG = OAK_TREE_CONFIG.func_236685_a_(ImmutableList.of(BEEHIVES));
   ...
   public static final BaseTreeFeatureConfig BIRCH_TREE_WITH_MANY_BEEHIVES_CONFIG = BIRCH_TREE_CONFIG.func_236685_a_(ImmutableList.of(MANY_BEEHIVES));
   ...
   public static final BlockClusterFeatureConfig NETHER_FIRE = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(FIRE), SimpleBlockPlacer.field_236447_c_)).tries(64).whitelist(ImmutableSet.of(NETHERRACK.getBlock())).func_227317_b_().build();
   ...
   public static final BlockClusterFeatureConfig CRIMSON_ROUTE = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(CRIMSON_ROOTS), new SimpleBlockPlacer())).tries(64).func_227317_b_().build();
   ...
   public static final LiquidsConfig WATER_SPRING_CONFIG = new LiquidsConfig(FLUID_WATER, true, 4, 1, ImmutableSet.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE));
   public static final LiquidsConfig LAVA_SPRING_CONFIG = new LiquidsConfig(FLUID_LAVA, true, 4, 1, ImmutableSet.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE));
   public static final LiquidsConfig NETHER_SPRING_CONFIG = new LiquidsConfig(FLUID_LAVA, false, 4, 1, ImmutableSet.of(Blocks.NETHERRACK));
   public static final LiquidsConfig NETHER_LAVA = new LiquidsConfig(FLUID_LAVA, true, 4, 1, ImmutableSet.of(Blocks.NETHERRACK, Blocks.SOUL_SAND, Blocks.GRAVEL, Blocks.MAGMA_BLOCK, Blocks.BLACKSTONE));
   public static final LiquidsConfig ENCLOSED_NETHER_SPRING_CONFIG = new LiquidsConfig(FLUID_LAVA, false, 5, 0, ImmutableSet.of(Blocks.NETHERRACK));
   public static final LiquidsConfig field_235138_aP_ = new LiquidsConfig(FLUID_LAVA, false, 4, 1, ImmutableSet.of(Blocks.SOUL_SAND));
   public static final LiquidsConfig field_235139_aQ_ = new LiquidsConfig(FLUID_LAVA, false, 5, 0, ImmutableSet.of(Blocks.SOUL_SAND));
   ...
   public static final NetherackBlobReplacementFeature field_235142_aT_ = (new NetherackBlobReplacementFeature.Builder()).func_236624_a_(new Vector3i(3, 3, 3)).func_236626_b_(new Vector3i(7, 7, 7)).func_236623_a_(Blocks.NETHERRACK.getDefaultState()).func_236625_b_(Blocks.BASALT.getDefaultState()).func_236622_a_();
   public static final NetherackBlobReplacementFeature field_235143_aU_ = (new NetherackBlobReplacementFeature.Builder()).func_236624_a_(new Vector3i(3, 3, 3)).func_236626_b_(new Vector3i(7, 7, 7)).func_236623_a_(Blocks.NETHERRACK.getDefaultState()).func_236625_b_(Blocks.BLACKSTONE.getDefaultState()).func_236622_a_();
   public static final BasaltDeltasFeature BASALT_DELTA = (new BasaltDeltasFeature.Builder()).func_236514_a_(Blocks.LAVA.getDefaultState()).func_236513_a_(3, 7).func_236515_a_(Blocks.MAGMA_BLOCK.getDefaultState(), 2).func_236512_a_();
   ...
   public static final BlockStateProvidingFeatureConfig CRIMSON_ROOTS_FEATURE_CONFIG = new BlockStateProvidingFeatureConfig((new WeightedBlockStateProvider()).addWeightedBlockstate(Blocks.CRIMSON_ROOTS.getDefaultState(), 87).addWeightedBlockstate(Blocks.CRIMSON_FUNGUS.getDefaultState(), 11).addWeightedBlockstate(Blocks.WARPED_FUNGUS.getDefaultState(), 1));
   public static final BlockStateProvidingFeatureConfig WARPED_ROOTS = new BlockStateProvidingFeatureConfig((new WeightedBlockStateProvider()).addWeightedBlockstate(Blocks.WARPED_ROOTS.getDefaultState(), 85).addWeightedBlockstate(Blocks.CRIMSON_ROOTS.getDefaultState(), 1).addWeightedBlockstate(Blocks.WARPED_FUNGUS.getDefaultState(), 13).addWeightedBlockstate(Blocks.CRIMSON_FUNGUS.getDefaultState(), 1));
   public static final BlockStateProvidingFeatureConfig NETHER_SPROUTS = new BlockStateProvidingFeatureConfig(new SimpleBlockStateProvider(Blocks.NETHER_SPROUTS.getDefaultState()));
   ...
   public static void func_235192_as_(Biome p_235192_0_) {
      ...
      p_235192_0_.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, Blocks.BLACKSTONE.getDefaultState(), 33)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 5, 10, 37))));
   ...
   public static void func_235190_a_(Biome p_235190_0_, int p_235190_1_, int p_235190_2_) {
      p_235190_0_.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, NETHER_GOLD_ORE, 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(p_235190_1_, 10, 20, 128))));
      p_235190_0_.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK, NETHER_QUARTZ_ORE, 14)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(p_235190_2_, 10, 20, 128))));
   }

   public static void func_235193_at_(Biome p_235193_0_) {
      p_235193_0_.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.field_236289_V_.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES, Blocks.ANCIENT_DEBRIS.getDefaultState(), 3)).withPlacement(Placement.COUNT_DEPTH_AVERAGE.configure(new DepthAverageConfig(1, 16, 8))));
      p_235193_0_.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.field_236289_V_.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES, Blocks.ANCIENT_DEBRIS.getDefaultState(), 2)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 8, 16, 128))));
   }
   ...
   public static void func_235194_au_(Biome p_235194_0_) {
      ...
      p_235194_0_.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_236282_M_.withConfiguration(CRIMSON_ROOTS_FEATURE_CONFIG).withPlacement(Placement.COUNT_HEIGHTMAP.configure(new FrequencyConfig(6))));
   }
   ...
   public static void func_235195_av_(Biome p_235195_0_) {
      ...
      p_235195_0_.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_236282_M_.withConfiguration(WARPED_ROOTS).withPlacement(Placement.COUNT_HEIGHTMAP.configure(new FrequencyConfig(5))));
      p_235195_0_.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_236282_M_.withConfiguration(NETHER_SPROUTS).withPlacement(Placement.COUNT_HEIGHTMAP.configure(new FrequencyConfig(4))));
