...
public abstract class Biomes {
   ...
   public static final Biome SOUL_SAND_VALLEY = register(170, "soul_sand_valley", new SoulSandBiome());
   ...
   private static Biome register(int id, String key, Biome biome) {
      Registry.register(Registry.BIOME, id, key, biome);
      if (biome.isMutation()) {
