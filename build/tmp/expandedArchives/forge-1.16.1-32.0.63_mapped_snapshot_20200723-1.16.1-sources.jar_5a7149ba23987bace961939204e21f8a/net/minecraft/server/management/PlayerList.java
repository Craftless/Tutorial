...
public abstract class PlayerList {
   ...
   private final IDynamicRegistries.Impl field_232639_s_;
   ...
   public ServerPlayerEntity func_232644_a_(ServerPlayerEntity p_232644_1_, boolean p_232644_2_) {
      ...
      if (serverworld != null && blockpos != null) {
         optional = PlayerEntity.func_234567_a_(serverworld, blockpos, flag, p_232644_2_);
      } else {
      ...
      if (optional.isPresent()) {
         ...
         serverplayerentity.setLocationAndAngles(vector3d.x, vector3d.y, vector3d.z, 0.0F, 0.0F);
         serverplayerentity.func_241153_a_(serverworld1.func_234923_W_(), blockpos, flag, false);
         flag1 = !p_232644_2_ && serverworld1.getBlockState(blockpos).getBlock() instanceof RespawnAnchorBlock;
      ...
      serverplayerentity.connection.sendPacket(new SWorldSpawnChangedPacket(serverworld1.func_241135_u_()));
   ...
   public void sendWorldInfo(ServerPlayerEntity playerIn, ServerWorld worldIn) {
      ...
      playerIn.connection.sendPacket(new SWorldSpawnChangedPacket(worldIn.func_241135_u_()));
