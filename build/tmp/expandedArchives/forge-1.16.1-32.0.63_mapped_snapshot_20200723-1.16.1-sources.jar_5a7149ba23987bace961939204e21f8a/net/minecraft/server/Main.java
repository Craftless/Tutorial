...
public class Main {
   ...
   public static void main(String[] p_main_0_) {
      ...
      try {
         ...
         if (!optionset.has(optionspec1) && !servereula.hasAcceptedEULA()) {
         ...
         ResourcePackList<ResourcePackInfo> resourcepacklist = new ResourcePackList<>(ResourcePackInfo::new, new ServerPackFinder(), new FolderPackFinder(saveformat$levelsave.func_237285_a_(FolderName.field_237251_g_).toFile(), IPackNameDecorator.WORLD));
         ...
         WorldSettingsImport<INBT> worldsettingsimport = WorldSettingsImport.func_240876_a_(NBTDynamicOps.INSTANCE, datapackregistries.getResourceManager(), idynamicregistries$impl);
