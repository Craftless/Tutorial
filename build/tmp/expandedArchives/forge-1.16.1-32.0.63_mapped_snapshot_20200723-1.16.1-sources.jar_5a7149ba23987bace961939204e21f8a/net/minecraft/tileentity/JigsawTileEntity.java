...
public class JigsawTileEntity extends TileEntity {
   ...
   public void read(BlockState state, CompoundNBT nbt) {
      ...
      this.field_235661_g_ = JigsawTileEntity.OrientationType.func_235673_a_(nbt.getString("joint")).orElseGet(() -> {
         return JigsawBlock.func_235508_h_(state).getAxis().isHorizontal() ? JigsawTileEntity.OrientationType.ALIGNED : JigsawTileEntity.OrientationType.ROLLABLE;
      });
   }
   ...
   public static final class RuntimePiece extends AbstractVillagePiece {
      public RuntimePiece(TemplateManager p_i231863_1_, JigsawPiece p_i231863_2_, BlockPos p_i231863_3_, int p_i231863_4_, Rotation p_i231863_5_, MutableBoundingBox p_i231863_6_) {
         super(IStructurePieceType.RUNTIME, p_i231863_1_, p_i231863_2_, p_i231863_3_, p_i231863_4_, p_i231863_5_, p_i231863_6_);
      }

      public RuntimePiece(TemplateManager p_i231864_1_, CompoundNBT p_i231864_2_) {
         super(p_i231864_1_, p_i231864_2_, IStructurePieceType.RUNTIME);
      }
   }
}