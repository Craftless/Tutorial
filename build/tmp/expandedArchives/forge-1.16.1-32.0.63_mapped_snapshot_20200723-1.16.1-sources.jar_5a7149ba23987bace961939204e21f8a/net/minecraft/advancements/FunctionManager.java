...
public class FunctionManager {
   ...
   public void tick() {
      ...
      if (this.loadFunctionsRun) {
         ...
         Collection<FunctionObject> collection = this.reloader.func_240942_b_().getOrCreate(LOAD_TAG_ID).getAllElements();
   ...
   private void clearAndResetTickFunctions(FunctionReloader reloader) {
      ...
      this.tickFunctions.addAll(reloader.func_240942_b_().getOrCreate(TICK_TAG_ID).getAllElements());
