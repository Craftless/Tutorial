...
public class EntityPredicate {
   ...
   public static LootContext getLootContext(ServerPlayerEntity player, Entity entity) {
      return (new LootContext.Builder(player.getServerWorld())).withParameter(LootParameters.THIS_ENTITY, entity).withParameter(LootParameters.POSITION, entity.getPosition()).withParameter(LootParameters.field_237457_g_, player.getPositionVec()).withRandom(player.getRNG()).build(LootParameterSets.field_237454_j_);
   }
