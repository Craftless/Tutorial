...
public class BlockPredicate {
   ...
   public static BlockPredicate deserialize(@Nullable JsonElement json) {
      if (json != null && !json.isJsonNull()) {
         ...
         if (jsonobject.has("tag")) {
            ...
            itag = TagCollectionManager.func_232928_e_().func_232923_a_().get(resourcelocation1);
            if (itag == null) {
   ...
   public JsonElement serialize() {
      if (this == ANY) {
         ...
         if (this.tag != null) {
            jsonobject.addProperty("tag", TagCollectionManager.func_232928_e_().func_232923_a_().func_232975_b_(this.tag).toString());
         }
