   ...
   public static FluidPredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         if (jsonobject.has("tag")) {
            ...
            itag = TagCollectionManager.func_232928_e_().func_232926_c_().get(resourcelocation1);
            if (itag == null) {
   ...
   public JsonElement serialize() {
      if (this == ANY) {
         ...
         if (this.fluidTag != null) {
            jsonobject.addProperty("tag", TagCollectionManager.func_232928_e_().func_232926_c_().func_232975_b_(this.fluidTag).toString());
         }
