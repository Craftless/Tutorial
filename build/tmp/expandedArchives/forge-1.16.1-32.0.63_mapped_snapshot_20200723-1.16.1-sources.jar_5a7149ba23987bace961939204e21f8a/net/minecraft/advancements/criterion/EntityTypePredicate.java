...
public abstract class EntityTypePredicate {
   ...
   public static EntityTypePredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         if (s.startsWith("#")) {
            ...
            return new EntityTypePredicate.TagPredicate(TagCollectionManager.func_232928_e_().func_232927_d_().getOrCreate(resourcelocation1));
         } else {
   ...
   static class TagPredicate extends EntityTypePredicate {
      ...
      public JsonElement serialize() {
         return new JsonPrimitive("#" + TagCollectionManager.func_232928_e_().func_232927_d_().func_232975_b_(this.tag));
      }
   }
