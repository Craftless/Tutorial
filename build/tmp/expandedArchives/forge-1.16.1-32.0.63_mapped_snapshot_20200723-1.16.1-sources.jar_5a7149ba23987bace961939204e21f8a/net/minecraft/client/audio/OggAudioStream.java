...
public class OggAudioStream implements IAudioStream {
   ...
   private boolean readOgg(OggAudioStream.Buffer p_216460_1_) throws IOException {
      if (this.pointer == 0L) {
         return false;
      } else {
         try (MemoryStack memorystack = MemoryStack.stackPush()) {
   ...
   private void func_216457_a(FloatBuffer p_216457_1_, OggAudioStream.Buffer p_216457_2_) {
      while(p_216457_1_.hasRemaining()) {
         p_216457_2_.write(p_216457_1_.get());
      }
   ...
   private void func_216458_a(FloatBuffer p_216458_1_, FloatBuffer p_216458_2_, OggAudioStream.Buffer p_216458_3_) {
      while(p_216458_1_.hasRemaining() && p_216458_2_.hasRemaining()) {
         p_216458_3_.write(p_216458_1_.get());
         p_216458_3_.write(p_216458_2_.get());
      }
   ...
   public ByteBuffer func_216455_a(int p_216455_1_) throws IOException {
      ...
      while(this.readOgg(oggaudiostream$buffer) && oggaudiostream$buffer.filledBytes < p_216455_1_) {
      }

      return oggaudiostream$buffer.read();
   }
   ...
   static class Buffer {
      ...
      public Buffer(int p_i50626_1_) {
         this.capacity = p_i50626_1_ + 1 & -2;
         this.createBuffer();
      }

      private void createBuffer() {
         this.field_216452_d = BufferUtils.createByteBuffer(this.capacity);
      }

      public void write(float p_216446_1_) {
         if (this.field_216452_d.remaining() == 0) {
            ((java.nio.Buffer)this.field_216452_d).flip();
            this.buffers.add(this.field_216452_d);
            this.createBuffer();
         }
