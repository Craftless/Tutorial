...
public class SoundEngine {
   ...
   private void tickNonPaused() {
      ++this.ticks;
      this.tickableSoundsToPlayOnNextTick.stream().filter(ISound::func_230510_t_).forEach(this::play);
      this.tickableSoundsToPlayOnNextTick.clear();
                        ...
                        if (channelmanager$entry == null) {
                           ...
                           channelmanager$entry.runOnSoundExecutor((p_239543_8_) -> {
                              ...
                              if (isound$attenuationtype == ISound.AttenuationType.LINEAR) {
                                 p_239543_8_.setLinearAttenuation(f1);
                              } else {
                                 p_239543_8_.setNoAttenuation();
                              }
                           ...
                           if (!flag3) {
                              this.audioStreamManager.createResource(sound.getSoundAsOggLocation()).thenAccept((p_217934_1_) -> {
                              ...
                              this.audioStreamManager.createStreamingResource(sound.getSoundAsOggLocation(), flag2).thenAccept((p_217928_1_) -> {
