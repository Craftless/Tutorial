...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable {
   ...
   protected void renderTooltip(MatrixStack matrixStack, ItemStack itemStack, int mouseX, int mouseY) {
      ...
      this.renderTooltip(matrixStack, this.getTooltipFromItem(itemStack), mouseX, mouseY, (font == null ? this.font : font));
   ...
   public void renderTooltip(MatrixStack p_238654_1_, List<? extends ITextProperties> p_238654_2_, int p_238654_3_, int p_238654_4_, FontRenderer font) {
      ...
      if (false && !p_238654_2_.isEmpty()) {
         ...
         for(ITextProperties itextproperties : p_238654_2_) {
            int j = this.font.func_238414_a_(itextproperties);
            if (j > i) {
               i = j;
            }
         }
         ...
         for(int l1 = 0; l1 < p_238654_2_.size(); ++l1) {
            ITextProperties itextproperties1 = p_238654_2_.get(l1);
            if (itextproperties1 != null) {
               this.font.func_238416_a_(itextproperties1, (float)i2, (float)j2, -1, true, matrix4f, irendertypebuffer$impl, false, 0, 15728880);
            }
         ...
         if (hoverevent$itemhover != null) {
            ...
            if (hoverevent$entityhover != null) {
               if (this.minecraft.gameSettings.advancedItemTooltips) {
                  this.renderTooltip(matrixStack, hoverevent$entityhover.getTooltip(), mouseX, mouseY);
               }
            } else {
