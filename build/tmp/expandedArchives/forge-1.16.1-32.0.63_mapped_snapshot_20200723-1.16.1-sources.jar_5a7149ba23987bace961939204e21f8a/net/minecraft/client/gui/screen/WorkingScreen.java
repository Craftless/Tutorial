   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      if (this.doneWorking) {
         ...
         if (this.field_238648_a_ != null) {
            this.drawCenteredString(matrixStack, this.font, this.field_238648_a_, this.width / 2, 70, 16777215);
         }

         if (this.stage != null && this.progress != 0) {
            this.drawCenteredString(matrixStack, this.font, (new StringTextComponent("")).append(this.stage).appendString(" " + this.progress + "%"), this.width / 2, 90, 16777215);
         }
