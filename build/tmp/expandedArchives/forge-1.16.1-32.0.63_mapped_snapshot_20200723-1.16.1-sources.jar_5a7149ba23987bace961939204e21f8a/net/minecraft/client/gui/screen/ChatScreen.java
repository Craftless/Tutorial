...
public class ChatScreen extends Screen {
   ...
   protected void init() {
      ...
      this.inputField = new TextFieldWidget(this.font, 4, this.height - 12, this.width - 4, 12, new TranslationTextComponent("chat.editBox")) {
         protected IFormattableTextComponent getNarrationMessage() {
            return super.getNarrationMessage().appendString(ChatScreen.this.commandSuggestionHelper.func_228129_c_());
         }
      };
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (this.commandSuggestionHelper.onClick((double)((int)mouseX), (double)((int)mouseY), p_231044_5_)) {
         return true;
      } else {
         if (p_231044_5_ == 0) {
         ...
         return this.inputField.mouseClicked(mouseX, mouseY, p_231044_5_) ? true : super.mouseClicked(mouseX, mouseY, p_231044_5_);
      }
   }
