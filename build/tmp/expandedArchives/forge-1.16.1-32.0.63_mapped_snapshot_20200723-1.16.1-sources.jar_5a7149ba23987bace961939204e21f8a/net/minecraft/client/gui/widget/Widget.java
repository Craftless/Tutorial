...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener {
   ...
   protected void onDrag(double mouseX, double p_230983_3_, double p_230983_5_, double p_230983_7_) {
   }
   ...
   public void setMessage(ITextComponent p_238482_1_) {
      if (!Objects.equals(p_238482_1_, this.message)) {
   ...
   public void queueNarration(int p_230994_1_) {
      this.nextNarration = Util.milliTime() + (long)p_230994_1_;
   }
