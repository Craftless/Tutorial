...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 - 155, this.height / 6 + 120 - 6, 150, 20, new TranslationTextComponent("options.resourcepack"), (p_213060_1_) -> {
         this.minecraft.displayGuiScreen(new ResourcePacksScreen(this, this.minecraft.getResourcePackList(), this::func_241584_a_, this.minecraft.getFileResourcePacks()));
      }));
      ...
      this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, DialogTexts.field_240632_c_, (p_213056_1_) -> {
         this.minecraft.displayGuiScreen(this.lastScreen);
      }));
   }

   private void func_241584_a_(ResourcePackList<ClientResourcePackInfo> p_241584_1_) {
      ...
      for(ClientResourcePackInfo clientresourcepackinfo : p_241584_1_.getEnabledPacks()) {
         if (!clientresourcepackinfo.isOrderLocked()) {
            this.settings.resourcePacks.add(clientresourcepackinfo.getName());
            if (!clientresourcepackinfo.getCompatibility().isCompatible()) {
               this.settings.incompatibleResourcePacks.add(clientresourcepackinfo.getName());
            }
         }
      }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 15, 16777215);
