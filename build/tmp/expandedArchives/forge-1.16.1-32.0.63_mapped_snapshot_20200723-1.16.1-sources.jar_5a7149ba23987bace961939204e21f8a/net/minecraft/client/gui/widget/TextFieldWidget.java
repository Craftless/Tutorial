   ...
   public void renderButton(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
      if (this.getVisible()) {
         ...
         if (!s.isEmpty()) {
            ...
            j1 = this.fontRenderer.drawStringWithShadow(p_230431_1_, this.textFormatter.apply(s1, this.lineScrollOffset), (float)l, (float)i1, i2);
         }
         ...
         if (!s.isEmpty() && flag && j < s.length()) {
            this.fontRenderer.drawStringWithShadow(p_230431_1_, this.textFormatter.apply(s.substring(j), this.cursorPosition), (float)j1, (float)i1, i2);
         }
