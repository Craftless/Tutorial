...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   public boolean charTyped(char p_231042_1_, int p_231042_2_) {
      if (this.field_195377_F) {
         ...
         String s = this.searchField.getText();
         if (this.searchField.charTyped(p_231042_1_, p_231042_2_)) {
   ...
   private void searchTags(String search) {
      ...
      tagcollection.getRegisteredTags().stream().filter(predicate).forEach((p_214082_2_) -> {
         ITag itag = this.tagSearchResults.put(p_214082_2_, tagcollection.get(p_214082_2_));
      });
   }
   ...
   protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
      ...
      if (itemgroup != null && itemgroup.drawInForegroundOfTab()) {
         ...
         this.font.drawString(matrixStack, I18n.format(itemgroup.getTranslationKey()), 8.0F, 6.0F, itemgroup.getLabelColor());
      }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.destroyItemSlot != null && selectedTabIndex == ItemGroup.INVENTORY.getIndex() && this.isPointInRegion(this.destroyItemSlot.xPos, this.destroyItemSlot.yPos, 16, 16, (double)mouseX, (double)mouseY)) {
         this.renderTooltip(matrixStack, new TranslationTextComponent("inventory.binSlot"), mouseX, mouseY);
      }
      ...
      if (maxPages != 0) {
          ...
          font.func_238407_a_(matrixStack, page, guiLeft + (xSize / 2) - (font.func_238414_a_(page) / 2), guiTop - 44, -1);
   ...
   protected void renderTooltip(MatrixStack matrixStack, ItemStack itemStack, int mouseX, int mouseY) {
      if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
         ...
         if (itemgroup != null) {
            list1.add(1, (new TranslationTextComponent(itemgroup.getTranslationKey())).mergeStyle(TextFormatting.BLUE));
         }
         ...
         this.renderTooltip(matrixStack, list1, mouseX, mouseY, (font == null ? this.font : font));
   ...
   protected boolean func_238809_a_(MatrixStack p_238809_1_, ItemGroup p_238809_2_, int p_238809_3_, int p_238809_4_) {
      ...
      if (this.isPointInRegion(j + 3, k + 3, 23, 27, (double)p_238809_3_, (double)p_238809_4_)) {
         this.renderTooltip(p_238809_1_, new TranslationTextComponent(p_238809_2_.getTranslationKey()), p_238809_3_, p_238809_4_);
         return true;
      } else {
         return false;
      }
