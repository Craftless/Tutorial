...
public class JigsawScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 - 50, 180, 100, 20, new TranslationTextComponent("jigsaw_block.keep_jigsaws"), (p_238832_1_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().appendString(" ").append(DialogTexts.func_240638_a_(JigsawScreen.this.field_238822_s_));
         }
      });
      this.addButton(new Button(this.width / 2 + 54, 180, 100, 20, new TranslationTextComponent("jigsaw_block.generate"), (p_238831_1_) -> {
         this.func_238835_m_();
      }));
      this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, DialogTexts.field_240632_c_, (p_238828_1_) -> {
         this.func_214256_b();
      }));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawString(matrixStack, this.font, I18n.format("jigsaw_block.pool"), this.width / 2 - 153, 10, 10526880);
      this.field_238820_p_.render(matrixStack, mouseX, mouseY, partialTicks);
      this.drawString(matrixStack, this.font, I18n.format("jigsaw_block.name"), this.width / 2 - 153, 45, 10526880);
      this.field_238818_b_.render(matrixStack, mouseX, mouseY, partialTicks);
      this.drawString(matrixStack, this.font, I18n.format("jigsaw_block.target"), this.width / 2 - 153, 80, 10526880);
      this.field_238819_c_.render(matrixStack, mouseX, mouseY, partialTicks);
      this.drawString(matrixStack, this.font, I18n.format("jigsaw_block.final_state"), this.width / 2 - 153, 115, 10526880);
      ...
      if (JigsawBlock.func_235508_h_(this.field_214259_a.getBlockState()).getAxis().isVertical()) {
         this.drawString(matrixStack, this.font, I18n.format("jigsaw_block.joint_label"), this.width / 2 - 153, 156, 16777215);
      }
