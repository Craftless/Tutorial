...
public class CreateBuffetWorldScreen extends Screen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, I18n.format("createWorld.customize.buffet.biome"), this.width / 2, 28, 10526880);
   ...
   class BiomeList extends ExtendedList<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
      ...
      public void setSelected(@Nullable CreateBuffetWorldScreen.BiomeList.BiomeEntry entry) {
         ...
         if (entry != null) {
            ...
            NarratorChatListener.INSTANCE.say((new TranslationTextComponent("narrator.select", entry.field_238599_b_.getDisplayName().getString())).getString());
         }
