...
public class CreateFlatWorldScreen extends Screen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawString(matrixStack, this.font, this.materialText, i, 32, 16777215);
      this.drawString(matrixStack, this.font, this.heightText, i + 2 + 213 - this.font.func_238414_a_(this.heightText), 32, 16777215);
