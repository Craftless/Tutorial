...
public class ResourcePackList extends ExtendedList<ResourcePackList.ResourcePackEntry> {
   ...
   protected void renderHeader(MatrixStack p_230448_1_, int p_230448_2_, int p_230448_3_, Tessellator p_230448_4_) {
      ...
      this.minecraft.fontRenderer.func_238422_b_(p_230448_1_, itextcomponent, (float)(p_230448_2_ + this.width / 2 - this.minecraft.fontRenderer.func_238414_a_(itextcomponent) / 2), (float)Math.min(this.y0 + 3, p_230448_3_), 16777215);
   }
