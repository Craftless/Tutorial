...
public class VideoSettingsScreen extends SettingsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      Optional<Widget> optional = this.optionsRowList.func_238518_c_((double)mouseX, (double)mouseY);
      ...
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 5, 16777215);
      super.render(matrixStack, mouseX, mouseY, partialTicks);
      if (this.field_238662_c_ != null) {
         this.renderTooltip(matrixStack, this.field_238662_c_, mouseX, mouseY);
      }
