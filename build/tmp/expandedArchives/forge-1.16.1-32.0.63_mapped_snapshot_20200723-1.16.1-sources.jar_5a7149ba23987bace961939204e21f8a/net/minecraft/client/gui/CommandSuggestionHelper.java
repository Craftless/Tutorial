...
public class CommandSuggestionHelper {
   ...
   public CommandSuggestionHelper(Minecraft mc, Screen p_i225919_2_, TextFieldWidget p_i225919_3_, FontRenderer p_i225919_4_, boolean p_i225919_5_, boolean p_i225919_6_, int p_i225919_7_, int p_i225919_8_, boolean p_i225919_9_, int p_i225919_10_) {
      this.mc = mc;
   ...
   public boolean onKeyPressed(int p_228115_1_, int p_228115_2_, int p_228115_3_) {
      if (this.suggestions != null && this.suggestions.onKeyPressed(p_228115_1_, p_228115_2_, p_228115_3_)) {
         return true;
      } else if (this.field_228094_c_.getListener() == this.field_228095_d_ && p_228115_1_ == 258) {
   ...
   public boolean onScroll(double p_228112_1_) {
      return this.suggestions != null && this.suggestions.func_228147_a_(MathHelper.clamp(p_228112_1_, -1.0D, 1.0D));
   }

   public boolean onClick(double p_228113_1_, double p_228113_3_, int p_228113_5_) {
      return this.suggestions != null && this.suggestions.func_228150_a_((int)p_228113_1_, (int)p_228113_3_, p_228113_5_);
   }
   ...
   public void func_228128_b_(boolean p_228128_1_) {
      if (this.suggestionsFuture != null && this.suggestionsFuture.isDone()) {
         ...
         if (!suggestions.isEmpty()) {
            ...
            this.suggestions = new CommandSuggestionHelper.Suggestions(j, k, i, this.func_241575_a_(suggestions), p_228128_1_);
         }
      }
   ...
   public void init() {
      ...
      if (flag1) {
         ...
         if (i >= j && (this.suggestions == null || !this.field_228110_s_)) {
   ...
   public void func_228125_b_() {
      if (this.field_228095_d_.getCursorPosition() == this.field_228095_d_.getText().length()) {
         if (this.suggestionsFuture.join().isEmpty() && !this.parseResults.getExceptions().isEmpty()) {
            ...
            this.field_228103_l_.add(Commands.func_227481_a_(this.parseResults).getMessage());
         }
      }
      ...
      this.suggestions = null;
      if (this.field_228109_r_ && this.mc.gameSettings.autoSuggestCommands) {
   ...
   private String func_228122_a_(String p_228122_1_, int p_228122_2_) {
      return this.parseResults != null ? func_228116_a_(this.parseResults, p_228122_1_, p_228122_2_) : p_228122_1_;
   }
   ...
   public void func_238500_a_(MatrixStack p_238500_1_, int p_238500_2_, int p_238500_3_) {
      if (this.suggestions != null) {
         this.suggestions.func_238501_a_(p_238500_1_, p_238500_2_, p_238500_3_);
      } else {
         int i = 0;

         for(String s : this.field_228103_l_) {
            int j = this.field_228101_j_ ? this.field_228094_c_.height - 14 - 13 - 12 * i : 72 + 12 * i;
            AbstractGui.fill(p_238500_1_, this.field_228104_m_ - 1, j, this.field_228104_m_ + this.field_228105_n_ + 1, j + 12, this.field_228102_k_);
            this.field_228096_e_.drawStringWithShadow(p_238500_1_, s, (float)this.field_228104_m_, (float)(j + 2), -1);
            ++i;
         }
      }
   ...
   public String func_228129_c_() {
      return this.suggestions != null ? "\n" + this.suggestions.func_228155_c_() : "";
   }
   ...
   public class Suggestions {
      ...
      public void func_238501_a_(MatrixStack p_238501_1_, int p_238501_2_, int p_238501_3_) {
         ...
         if (flag2) {
            AbstractGui.fill(p_238501_1_, this.field_228138_b_.getX(), this.field_228138_b_.getY() - 1, this.field_228138_b_.getX() + this.field_228138_b_.getWidth(), this.field_228138_b_.getY(), CommandSuggestionHelper.this.field_228102_k_);
            AbstractGui.fill(p_238501_1_, this.field_228138_b_.getX(), this.field_228138_b_.getY() + this.field_228138_b_.getHeight(), this.field_228138_b_.getX() + this.field_228138_b_.getWidth(), this.field_228138_b_.getY() + this.field_228138_b_.getHeight() + 1, CommandSuggestionHelper.this.field_228102_k_);
            if (flag) {
               for(int k = 0; k < this.field_228138_b_.getWidth(); ++k) {
                  if (k % 2 == 0) {
                     AbstractGui.fill(p_238501_1_, this.field_228138_b_.getX() + k, this.field_228138_b_.getY() - 1, this.field_228138_b_.getX() + k + 1, this.field_228138_b_.getY(), -1);
                  }
               }
            }
            ...
            if (flag1) {
               for(int i1 = 0; i1 < this.field_228138_b_.getWidth(); ++i1) {
                  if (i1 % 2 == 0) {
                     AbstractGui.fill(p_238501_1_, this.field_228138_b_.getX() + i1, this.field_228138_b_.getY() + this.field_228138_b_.getHeight(), this.field_228138_b_.getX() + i1 + 1, this.field_228138_b_.getY() + this.field_228138_b_.getHeight() + 1, -1);
                  }
               }
            }
         }
         ...
         for(int l = 0; l < i; ++l) {
            ...
            AbstractGui.fill(p_238501_1_, this.field_228138_b_.getX(), this.field_228138_b_.getY() + 12 * l, this.field_228138_b_.getX() + this.field_228138_b_.getWidth(), this.field_228138_b_.getY() + 12 * l + 12, CommandSuggestionHelper.this.field_228102_k_);
            ...
            CommandSuggestionHelper.this.field_228096_e_.drawStringWithShadow(p_238501_1_, suggestion.getText(), (float)(this.field_228138_b_.getX() + 1), (float)(this.field_228138_b_.getY() + 2 + 12 * l), l + this.field_228141_e_ == this.field_228142_f_ ? -256 : -5592406);
         }

         if (flag4) {
            Message message = this.field_241576_d_.get(this.field_228142_f_).getTooltip();
            if (message != null) {
               CommandSuggestionHelper.this.field_228094_c_.renderTooltip(p_238501_1_, TextComponentUtils.toTextComponent(message), p_238501_2_, p_238501_3_);
            }
         }
      ...
      public boolean onKeyPressed(int p_228154_1_, int p_228154_2_, int p_228154_3_) {
         if (p_228154_1_ == 265) {
