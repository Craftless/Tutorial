...
public class LanguageScreen extends SettingsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 16, 16777215);
      this.drawCenteredString(matrixStack, this.font, "(" + I18n.format("options.languageWarning") + ")", this.width / 2, this.height - 56, 8421504);
