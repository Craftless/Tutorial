...
public class ShareToLanScreen extends Screen {
   ...
   private void updateDisplayNames() {
      this.gameModeButton.setMessage((new TranslationTextComponent("selectWorld.gameMode")).appendString(": ").append(new TranslationTextComponent("selectWorld.gameMode." + this.gameMode)));
      this.allowCheatsButton.setMessage((new TranslationTextComponent("selectWorld.allowCommands")).appendString(" ").append(DialogTexts.func_240638_a_(this.allowCheats)));
   }

   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      this.renderBackground(matrixStack);
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 50, 16777215);
      this.drawCenteredString(matrixStack, this.font, I18n.format("lanServer.otherPlayers"), this.width / 2, 82, 16777215);
