...
public class MultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 + 4 + 76, this.height - 28, 75, 20, DialogTexts.field_240633_d_, (p_214289_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.hoveringText != null) {
         this.renderTooltip(matrixStack, this.hoveringText, mouseX, mouseY);
      }
