...
public class ConnectingScreen extends Screen {
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, DialogTexts.field_240633_d_, (p_212999_1_) -> {
         this.cancel = true;
         if (this.networkManager != null) {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.field_209515_s, this.width / 2, this.height / 2 - 50, 16777215);
