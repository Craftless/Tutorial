...
public class FlatPresetsScreen extends Screen {
   ...
   private static FlatLayerInfo func_238638_a_(String p_238638_0_, int p_238638_1_) {
      ...
      Block block;
      try {
         block = Registry.BLOCK.getValue(new ResourceLocation(s)).orElse((Block)null);
   ...
   public static FlatGenerationSettings func_241596_a_(String p_241596_0_, FlatGenerationSettings p_241596_1_) {
      Iterator<String> iterator = Splitter.on(';').split(p_241596_0_).iterator();
      if (!iterator.hasNext()) {
         return FlatGenerationSettings.getDefaultFlatGenerator();
      } else {
         List<FlatLayerInfo> list = func_238637_a_(iterator.next());
         if (list.isEmpty()) {
            return FlatGenerationSettings.getDefaultFlatGenerator();
         } else {
            FlatGenerationSettings flatgenerationsettings = p_241596_1_.func_241527_a_(list, p_241596_1_.func_236943_d_());
   ...
   private static String func_238642_b_(FlatGenerationSettings p_238642_0_) {
      StringBuilder stringbuilder = new StringBuilder();

      for(int i = 0; i < p_238642_0_.getFlatLayers().size(); ++i) {
         if (i > 0) {
            stringbuilder.append(",");
         }

         stringbuilder.append(p_238642_0_.getFlatLayers().get(i));
      }

      stringbuilder.append(";");
      stringbuilder.append((Object)Registry.BIOME.getKey(p_238642_0_.getBiome()));
   ...
   protected void init() {
      ...
      this.export.setText(func_238642_b_(this.parentScreen.func_238603_g_()));
      ...
      this.btnSelect = this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, new TranslationTextComponent("createWorld.customize.presets.select"), (p_213076_1_) -> {
         FlatGenerationSettings flatgenerationsettings = func_241596_a_(this.export.getText(), this.field_241594_u_);
         this.parentScreen.func_238602_a_(flatgenerationsettings);
         this.minecraft.displayGuiScreen(this.parentScreen);
      }));
      this.addButton(new Button(this.width / 2 + 5, this.height - 28, 150, 20, DialogTexts.field_240633_d_, (p_238634_1_) -> {
         this.minecraft.displayGuiScreen(this.parentScreen);
      }));
   ...
   public boolean mouseScrolled(double mouseX, double mouseY, double p_231043_5_) {
      return this.list.mouseScrolled(mouseX, mouseY, p_231043_5_);
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 8, 16777215);
      this.drawString(matrixStack, this.font, this.presetsShare, 50, 30, 10526880);
      this.drawString(matrixStack, this.font, this.listText, 50, 70, 10526880);
   ...
   private static void func_238640_a_(ITextComponent p_238640_0_, IItemProvider p_238640_1_, Biome p_238640_2_, List<Structure<?>> p_238640_3_, boolean p_238640_4_, boolean p_238640_5_, boolean p_238640_6_, FlatLayerInfo... p_238640_7_) {
      ...
      flatgenerationsettings.setBiome(p_238640_2_);
      flatgenerationsettings.updateLayers();
      FLAT_WORLD_PRESETS.add(new FlatPresetsScreen.LayerItem(p_238640_1_.asItem(), p_238640_0_, flatgenerationsettings.func_236937_a_(dimensionstructuressettings)));
   }
   ...
   static class LayerItem {
      ...
      public final FlatGenerationSettings field_238643_c_;

      public LayerItem(Item p_i232278_1_, ITextComponent p_i232278_2_, FlatGenerationSettings p_i232278_3_) {
         this.icon = p_i232278_1_;
         this.name = p_i232278_2_;
         this.field_238643_c_ = p_i232278_3_;
      }
   ...
   class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
      ...
      public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry> {
         public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            FlatPresetsScreen.this.font.func_238422_b_(p_230432_1_, flatpresetsscreen$layeritem.name, (float)(p_230432_4_ + 18 + 5), (float)(p_230432_3_ + 6), 16777215);
         }
         ...
         private void func_214399_a() {
            ...
            FlatPresetsScreen.this.export.setText(FlatPresetsScreen.func_238642_b_(flatpresetsscreen$layeritem.field_238643_c_));
            FlatPresetsScreen.this.export.setCursorPositionZero();
            FlatPresetsScreen.this.field_241594_u_ = flatpresetsscreen$layeritem.field_238643_c_;
         }
