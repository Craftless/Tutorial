...
public class EditBookScreen extends Screen {
   ...
   private void func_238760_a_(String p_238760_1_) {
      if (this.minecraft != null) {
         TextInputUtil.func_238571_a_(this.minecraft, p_238760_1_);
      }
   ...
   protected void init() {
      ...
      this.buttonDone = this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, DialogTexts.field_240632_c_, (p_214204_1_) -> {
      ...
      this.buttonCancel = this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, DialogTexts.field_240633_d_, (p_214212_1_) -> {
         if (this.bookGettingSigned) {
   ...
   public boolean charTyped(char p_231042_1_, int p_231042_2_) {
      if (super.charTyped(p_231042_1_, p_231042_2_)) {
         ...
         boolean flag = this.field_238749_v_.putChar(p_231042_1_);
         if (flag) {
            this.updateButtons();
            this.bookIsModified = true;
            return true;
         ...
         this.field_238748_u_.putText(Character.toString(p_231042_1_));
         this.func_238751_C_();
         return true;
      } else {
         return false;
   ...
   private boolean keyPressedInBook(int keyCode, int scanCode, int modifiers) {
      if (Screen.isSelectAll(keyCode)) {
         ...
         case 261:
            ...
            return true;
         case 262:
            this.field_238748_u_.func_238569_a_(1, Screen.hasShiftDown());
            return true;
         case 263:
            this.field_238748_u_.func_238569_a_(-1, Screen.hasShiftDown());
            return true;
   ...
   private void func_238755_a_(int p_238755_1_) {
      ...
      this.field_238748_u_.func_238581_c_(j, Screen.hasShiftDown());
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         for(EditBookScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
            this.font.func_238422_b_(matrixStack, editbookscreen$bookline.field_238797_c_, (float)editbookscreen$bookline.field_238798_d_, (float)editbookscreen$bookline.field_238799_e_, -16777216);
         }
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (super.mouseClicked(mouseX, mouseY, p_231044_5_)) {
         return true;
      } else {
         if (p_231044_5_ == 0) {
   ...
   public boolean mouseDragged(double p_231045_1_, double p_231045_3_, int p_231045_5_, double p_231045_6_, double p_231045_8_) {
      if (super.mouseDragged(p_231045_1_, p_231045_3_, p_231045_5_, p_231045_6_, p_231045_8_)) {
         ...
         if (p_231045_5_ == 0) {
            EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();
            int i = editbookscreen$bookpage.func_238789_a_(this.font, this.func_238758_a_(new EditBookScreen.Point((int)p_231045_1_, (int)p_231045_3_)));
