...
public class AddServerScreen extends Screen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 17, 16777215);
      this.drawString(matrixStack, this.font, I18n.format("addServer.enterName"), this.width / 2 - 100, 53, 10526880);
      this.drawString(matrixStack, this.font, I18n.format("addServer.enterIp"), this.width / 2 - 100, 94, 10526880);
