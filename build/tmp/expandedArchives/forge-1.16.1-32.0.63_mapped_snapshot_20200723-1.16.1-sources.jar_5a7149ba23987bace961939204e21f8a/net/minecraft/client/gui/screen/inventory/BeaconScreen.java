...
public class BeaconScreen extends ContainerScreen<BeaconContainer> {
   ...
   protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
      this.drawCenteredString(matrixStack, this.font, I18n.format("block.minecraft.beacon.primary"), 62, 10, 14737632);
      this.drawCenteredString(matrixStack, this.font, I18n.format("block.minecraft.beacon.secondary"), 169, 10, 14737632);
