...
public class EditGamerulesScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 29, 150, 20, DialogTexts.field_240633_d_, (p_238976_1_) -> {
         this.field_238965_a_.accept(Optional.empty());
      }));
      this.field_238968_p_ = this.addButton(new Button(this.width / 2 - 155, this.height - 29, 150, 20, DialogTexts.field_240632_c_, (p_238971_1_) -> {
   ...
   private void func_238980_b_(@Nullable List<ITextProperties> p_238980_1_) {
   ...
   public class BooleanEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public BooleanEntry(final ITextComponent p_i232311_2_, List<ITextProperties> p_i232311_3_, final String p_i232311_4_, final GameRules.BooleanValue p_i232311_5_) {
         ...
         this.field_238986_c_ = new Button(10, 5, 44, 20, DialogTexts.func_240638_a_(p_i232311_5_.get()), (p_238988_1_) -> {
            ...
            protected IFormattableTextComponent getNarrationMessage() {
               return BooleanEntry.this.func_238989_a_(p_i232311_2_, p_i232311_5_.get()).deepCopy().appendString("\n").appendString(p_i232311_4_);
            }
         };
         this.field_241647_b_.add(this.field_238986_c_);
      }

      private IFormattableTextComponent func_238989_a_(ITextComponent p_238989_1_, boolean p_238989_2_) {
         return (new StringTextComponent("")).append(p_238989_1_).appendString(": ").append(DialogTexts.func_240638_a_(p_238989_2_));
      }
   ...
   public abstract class Gamerule extends AbstractOptionList.Entry<EditGamerulesScreen.Gamerule> {
      ...
      public Gamerule(@Nullable List<ITextProperties> p_i232315_2_) {
      ...
      public GamerulesList(final GameRules p_i232316_2_) {
         ...
         GameRules.visitAll(new GameRules.IRuleEntryVisitor() {
            ...
            private <T extends GameRules.RuleValue<T>> void func_239011_a_(GameRules.RuleKey<T> p_239011_1_, EditGamerulesScreen.IRuleEntry<T> p_239011_2_) {
               ...
               List<ITextProperties> list;
               String s2;
               if (I18n.hasKey(s1)) {
                  Builder<ITextProperties> builder = ImmutableList.<ITextProperties>builder().add(itextcomponent1);
                  ...
                  list = builder.add(itextcomponent2).build();
                  s2 = itextcomponent3.getString() + "\n" + itextcomponent2.getString();
               } else {
                  list = ImmutableList.of(itextcomponent1, itextcomponent2);
   ...
   interface IRuleEntry<T extends GameRules.RuleValue<T>> {
      EditGamerulesScreen.Gamerule create(ITextComponent p_create_1_, List<ITextProperties> p_create_2_, String p_create_3_, T p_create_4_);
   }
   ...
   public class IntegerEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public IntegerEntry(ITextComponent p_i232314_2_, List<ITextProperties> p_i232314_3_, String p_i232314_4_, GameRules.IntegerValue p_i232314_5_) {
   ...
   public class NameEntry extends EditGamerulesScreen.Gamerule {
      ...
      public NameEntry(ITextComponent p_i232313_2_) {
         super((List<ITextProperties>)null);
         this.field_238994_c_ = p_i232313_2_;
      }

      public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         EditGamerulesScreen.this.drawCenteredString(p_230432_1_, EditGamerulesScreen.this.minecraft.fontRenderer, this.field_238994_c_, p_230432_4_ + p_230432_5_ / 2, p_230432_3_ + 5, 16777215);
      }
   ...
   public abstract class ValueEntry extends EditGamerulesScreen.Gamerule {
      ...
      public ValueEntry(@Nullable List<ITextProperties> p_i241256_2_, ITextComponent p_i241256_3_) {
         super(p_i241256_2_);
