...
public class AdvancementsScreen extends Screen implements ClientAdvancementManager.IListener {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (p_231044_5_ == 0) {
         ...
         for(AdvancementTabGui advancementtabgui : this.tabs.values()) {
            if (advancementtabgui.getPage() == tabPage && advancementtabgui.func_195627_a(i, j, mouseX, mouseY)) {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (maxPages != 0) {
         ...
         int width = this.font.func_238414_a_(page);
         RenderSystem.disableLighting();
         this.font.func_238407_a_(matrixStack, page, i + (252 / 2) - (width / 2), j - 44, -1);
      }
      this.func_238696_c_(matrixStack, mouseX, mouseY, i, j);
      this.func_238695_a_(matrixStack, i, j);
      this.func_238697_d_(matrixStack, mouseX, mouseY, i, j);
   }
   ...
   private void func_238696_c_(MatrixStack p_238696_1_, int p_238696_2_, int p_238696_3_, int p_238696_4_, int p_238696_5_) {
      ...
      if (advancementtabgui == null) {
         ...
         this.font.drawString(p_238696_1_, s, (float)(p_238696_4_ + 9 + 117 - i / 2), (float)(p_238696_5_ + 18 + 56 - 9 / 2), -1);
         this.font.drawString(p_238696_1_, ":(", (float)(p_238696_4_ + 9 + 117 - this.font.getStringWidth(":(") / 2), (float)(p_238696_5_ + 18 + 113 - 9), -1);
      } else {
   ...
   public void func_238695_a_(MatrixStack p_238695_1_, int p_238695_2_, int p_238695_3_) {
      ...
      this.font.drawString(p_238695_1_, I18n.format("gui.advancements"), (float)(p_238695_2_ + 8), (float)(p_238695_3_ + 6), 4210752);
   }
      ...
      if (this.tabs.size() > 1) {
         for(AdvancementTabGui advancementtabgui : this.tabs.values()) {
            if (advancementtabgui.getPage() == tabPage && advancementtabgui.func_195627_a(p_238697_4_, p_238697_5_, (double)p_238697_2_, (double)p_238697_3_)) {
               this.renderTooltip(p_238697_1_, advancementtabgui.func_238685_d_(), p_238697_2_, p_238697_3_);
            }
         }
      }
