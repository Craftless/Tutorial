...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
   ...
   protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
      ...
      if (i > 0 && i <= 5 && this.container.func_217042_i()) {
         String s = "- " + I18n.format("merchant.level." + i);
         int j = this.font.func_238414_a_(this.title);
         int k = this.font.getStringWidth(s);
         int l = j + k + 3;
         int i1 = 49 + this.xSize / 2 - l / 2;
         this.font.func_238422_b_(matrixStack, this.title, (float)i1, 6.0F, 4210752);
         this.font.drawString(matrixStack, s, (float)(i1 + j + 3), 6.0F, 4210752);
      } else {
         this.font.func_238422_b_(matrixStack, this.title, (float)(49 + this.xSize / 2 - this.font.func_238414_a_(this.title) / 2), 6.0F, 4210752);
      }

      this.font.func_238422_b_(matrixStack, this.playerInventory.getDisplayName(), (float)this.playerInventoryTitleX, (float)this.playerInventoryTitleY, 4210752);
      String s1 = I18n.format("merchant.trades");
      int j1 = this.font.getStringWidth(s1);
      this.font.drawString(matrixStack, s1, (float)(5 - j1 / 2 + 48), 6.0F, 4210752);
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer1.hasNoUsesLeft() && this.isPointInRegion(186, 35, 22, 21, (double)mouseX, (double)mouseY) && this.container.func_223432_h()) {
            this.renderTooltip(matrixStack, new TranslationTextComponent("merchant.deprecated"), mouseX, mouseY);
         }
   ...
   private void func_238841_a_(MatrixStack p_238841_1_, ItemStack p_238841_2_, ItemStack p_238841_3_, int p_238841_4_, int p_238841_5_) {
      this.itemRenderer.func_239390_c_(p_238841_2_, p_238841_4_, p_238841_5_);
