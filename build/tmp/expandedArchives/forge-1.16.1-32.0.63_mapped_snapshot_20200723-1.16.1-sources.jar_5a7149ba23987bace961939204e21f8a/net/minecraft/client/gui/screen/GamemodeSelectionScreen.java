   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      if (!this.func_238718_l_()) {
         ...
         this.field_238707_q_.ifPresent((p_238712_2_) -> {
            this.drawCenteredString(matrixStack, this.font, p_238712_2_.func_238725_a_(), this.width / 2, this.height / 2 - 30 - 20, -1);
         });
         this.drawCenteredString(matrixStack, this.font, field_238705_c_, this.width / 2, this.height / 2 + 5, 16777215);
