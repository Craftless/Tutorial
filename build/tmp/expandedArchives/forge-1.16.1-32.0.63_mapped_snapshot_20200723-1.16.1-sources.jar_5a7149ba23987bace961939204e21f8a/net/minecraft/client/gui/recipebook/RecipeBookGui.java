...
public class RecipeBookGui extends AbstractGui implements IRenderable, IGuiEventListener, IRecipeUpdateListener, IRecipePlacer<Ingredient> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      if (this.isVisible()) {
         ...
         if (!this.searchBar.isFocused() && this.searchBar.getText().isEmpty()) {
            this.drawString(matrixStack, this.mc.fontRenderer, field_241620_l_, i + 25, j + 14, -1);
         } else {
   ...
   protected ITextComponent func_230478_f_() {
      return new TranslationTextComponent(this.toggleRecipesBtn.isStateTriggered() ? "gui.recipebook.toggleRecipes.craftable" : "gui.recipebook.toggleRecipes.all");
   }
   ...
   private void func_238925_d_(MatrixStack p_238925_1_, int p_238925_2_, int p_238925_3_, int p_238925_4_, int p_238925_5_) {
      ...
      if (itemstack != null && this.mc.currentScreen != null) {
         this.mc.currentScreen.renderTooltip(p_238925_1_, this.mc.currentScreen.getTooltipFromItem(itemstack), p_238925_4_, p_238925_5_);
      }
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (this.recipeBookPage.func_198955_a(mouseX, mouseY, p_231044_5_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
            ...
            return true;
         } else if (this.searchBar.mouseClicked(mouseX, mouseY, p_231044_5_)) {
            return true;
         } else if (this.toggleRecipesBtn.mouseClicked(mouseX, mouseY, p_231044_5_)) {
            ...
            for(RecipeTabToggleWidget recipetabtogglewidget : this.recipeTabs) {
               if (recipetabtogglewidget.mouseClicked(mouseX, mouseY, p_231044_5_)) {
   ...
   public boolean charTyped(char p_231042_1_, int p_231042_2_) {
      if (this.field_199738_u) {
         ...
         if (this.searchBar.charTyped(p_231042_1_, p_231042_2_)) {
            this.updateSearch();
            return true;
         } else {
   ...
   protected void sendUpdateSettings() {
      if (this.mc.getConnection() != null) {
         this.mc.getConnection().sendPacket(new CRecipeInfoPacket(this.recipeBook.isGuiOpen(), this.recipeBook.isFilteringCraftable(), this.recipeBook.isFurnaceGuiOpen(), this.recipeBook.isFurnaceFilteringCraftable(), this.recipeBook.isBlastFurnaceGuiOpen(), this.recipeBook.isBlastFurnaceFilteringCraftable()));
      }
