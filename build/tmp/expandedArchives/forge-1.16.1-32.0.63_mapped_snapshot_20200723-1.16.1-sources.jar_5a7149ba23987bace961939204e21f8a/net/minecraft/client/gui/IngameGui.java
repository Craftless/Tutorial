...
public class IngameGui extends AbstractGui {
   ...
   public void func_238445_a_(MatrixStack p_238445_1_, float p_238445_2_) {
      ...
      if (!this.mc.gameSettings.hideGUI) {
         ...
         if (this.mc.player.isRidingHorse()) {
            this.func_238446_a_(p_238445_1_, l);
         } else if (this.mc.playerController.gameIsSurvivalOrAdventure()) {
            this.func_238454_b_(p_238445_1_, l);
         }
      ...
      if (this.mc.player.getSleepTimer() > 0) {
         ...
         fill(p_238445_1_, 0, 0, this.scaledWidth, this.scaledHeight, i);
         RenderSystem.enableAlphaTest();
         RenderSystem.enableDepthTest();
         this.mc.getProfiler().endSection();
         RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      ...
      if (!this.mc.gameSettings.hideGUI) {
         if (this.overlayMessage != null && this.overlayMessageTime > 0) {
            ...
            if (i1 > 8) {
               ...
               int k = fontrenderer.func_238414_a_(this.overlayMessage);
               this.func_238448_a_(p_238445_1_, fontrenderer, -4, k, 16777215 | j);
               fontrenderer.func_238422_b_(p_238445_1_, this.overlayMessage, (float)(-k / 2), -4.0F, k1 | j);
               RenderSystem.disableBlend();
         ...
         if (this.displayedTitle != null && this.titlesTimer > 0) {
            ...
            if (j1 > 8) {
               ...
               fontrenderer.func_238407_a_(p_238445_1_, this.displayedTitle, (float)(-i2 / 2), -10.0F, 16777215 | l1);
               RenderSystem.popMatrix();
               if (this.displayedSubTitle != null) {
                  ...
                  fontrenderer.func_238407_a_(p_238445_1_, this.displayedSubTitle, (float)(-k2 / 2), 5.0F, 16777215 | l1);
                  RenderSystem.popMatrix();
               }
   ...
   public void func_238453_b_(MatrixStack p_238453_1_) {
      ...
      if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty()) {
         ...
         if (l > 0) {
            ...
            if (font == null) {
               this.getFontRenderer().func_238407_a_(p_238453_1_, highlightTip, (float)j, (float)k, 16777215 + (l << 24));
            } else {
   ...
   public void func_238455_c_(MatrixStack p_238455_1_) {
      ...
      this.getFontRenderer().drawStringWithShadow(p_238455_1_, s, (float)(this.scaledWidth - i - 10), 5.0F, 16777215);
      this.mc.getProfiler().endSection();
   }
   ...
   protected void func_238447_a_(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
      ...
      for(Pair<Score, ITextComponent> pair : list1) {
         ...
         this.getFontRenderer().func_238422_b_(p_238447_1_, itextcomponent2, (float)l2, (float)k1, -1);
         ...
         if (l == collection.size()) {
            ...
            this.getFontRenderer().func_238422_b_(p_238447_1_, itextcomponent, (float)(l2 + j / 2 - i / 2), (float)(k1 - 9), -1);
         }
      }
