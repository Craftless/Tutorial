...
public class OptimizeWorldScreen extends Screen {
   ...
   public static OptimizeWorldScreen func_239025_a_(Minecraft p_239025_0_, BooleanConsumer p_239025_1_, DataFixer p_239025_2_, SaveFormat.LevelSave p_239025_3_, boolean p_239025_4_) {
      ...
      try (Minecraft.PackManager minecraft$packmanager = p_239025_0_.func_238189_a_(idynamicregistries$impl, Minecraft::func_238180_a_, Minecraft::func_238181_a_, false, p_239025_3_)) {
         IServerConfiguration iserverconfiguration = minecraft$packmanager.func_238226_c_();
         p_239025_3_.func_237287_a_(idynamicregistries$impl, iserverconfiguration);
   ...
   protected void init() {
      super.init();
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 150, 200, 20, DialogTexts.field_240633_d_, (p_214331_1_) -> {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      int l = k + 10;
      this.drawCenteredString(matrixStack, this.font, this.optimizer.getStatusText(), this.width / 2, k - 9 - 2, 10526880);
      if (this.optimizer.getTotalChunks() > 0) {
         fill(matrixStack, i - 1, k - 1, j + 1, l + 1, -16777216);
         this.drawString(matrixStack, this.font, I18n.format("optimizeWorld.info.converted", this.optimizer.getConverted()), i, 40, 10526880);
         this.drawString(matrixStack, this.font, I18n.format("optimizeWorld.info.skipped", this.optimizer.getSkipped()), i, 40 + 9 + 3, 10526880);
         this.drawString(matrixStack, this.font, I18n.format("optimizeWorld.info.total", this.optimizer.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
         int i1 = 0;
         ...
         this.drawCenteredString(matrixStack, this.font, k1 + " / " + this.optimizer.getTotalChunks(), this.width / 2, k + 2 * 9 + 2, 10526880);
         this.drawCenteredString(matrixStack, this.font, MathHelper.floor(this.optimizer.getTotalProgress() * 100.0F) + "%", this.width / 2, k + (l - k) / 2 - 9 / 2, 10526880);
      }
