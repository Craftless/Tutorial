...
public class MainMenuScreen extends Screen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if ((l & -67108864) != 0) {
         ...
         if (this.splashText != null) {
            ...
            this.drawCenteredString(matrixStack, this.font, this.splashText, 0, -8, 16776960 | l);
         ...
         net.minecraftforge.fml.BrandingControl.forEachLine(true, true, (brdline, brd) ->
               this.drawString(matrixStack, this.font, brd, 2, this.height - ( 10 + brdline * (this.font.FONT_HEIGHT + 1)), 16777215 | l)
         );

         net.minecraftforge.fml.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
               this.drawString(matrixStack, this.font, brd, this.width - font.getStringWidth(brd), this.height - (10 + (brdline + 1) * ( this.font.FONT_HEIGHT + 1)), 16777215 | l)
         );
         this.drawString(matrixStack, this.font, "Copyright Mojang AB. Do not distribute!", this.widthCopyrightRest, this.height - 10, 16777215 | l);
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (super.mouseClicked(mouseX, mouseY, p_231044_5_)) {
         return true;
      } else if (this.areRealmsNotificationsEnabled() && this.realmsNotification.mouseClicked(mouseX, mouseY, p_231044_5_)) {
         return true;
      } else {
