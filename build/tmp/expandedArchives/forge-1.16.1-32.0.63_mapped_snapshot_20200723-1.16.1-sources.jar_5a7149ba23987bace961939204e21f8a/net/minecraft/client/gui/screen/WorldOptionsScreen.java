...
public class WorldOptionsScreen implements IScreen, IRenderable {
   ...
   public WorldOptionsScreen(IDynamicRegistries.Impl p_i232320_1_, DimensionGeneratorSettings p_i232320_2_) {
      ...
      this.field_239041_o_ = Long.toString(p_i232320_2_.getSeed());
   }
   ...
   public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_) {
      ...
      this.field_239034_h_ = p_239048_1_.addButton(new Button(i, 100, 150, 20, new TranslationTextComponent("selectWorld.mapFeatures"), (p_239056_1_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().appendString(" ").append(DialogTexts.func_240638_a_(WorldOptionsScreen.this.field_239039_m_.doesGenerateFeatures()));
         }
      ...
      this.field_239027_a_ = p_239048_1_.addButton(new Button(i, 151, 150, 20, new TranslationTextComponent("selectWorld.bonusItems"), (p_239047_1_) -> {
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().appendString(" ").append(DialogTexts.func_240638_a_(WorldOptionsScreen.this.field_239039_m_.hasBonusChest() && !p_239048_1_.hardCoreMode));
         }
      });
      ...
      this.field_239037_k_ = p_239048_1_.addButton(new Button(i, 185, 150, 20, new TranslationTextComponent("selectWorld.import_worldgen_settings"), (p_239049_3_) -> {
         ...
         if (s != null) {
            ...
            ResourcePackList<ResourcePackInfo> resourcepacklist = new ResourcePackList<>(ResourcePackInfo::new, new ServerPackFinder(), new FolderPackFinder(p_239048_1_.func_238957_j_().toFile(), IPackNameDecorator.WORLD));
            ...
            WorldSettingsImport<JsonElement> worldsettingsimport = WorldSettingsImport.func_240876_a_(JsonOps.INSTANCE, datapackregistries.getResourceManager(), idynamicregistries$impl);
            ...
            dataresult.resultOrPartial(field_239028_b_::error).ifPresent((p_239046_5_) -> {
               BooleanConsumer booleanconsumer = (p_239045_5_) -> {
                  ...
                  if (p_239045_5_) {
                     this.func_239052_a_(idynamicregistries$impl, p_239046_5_);
                  }
   ...
   private void func_239052_a_(IDynamicRegistries.Impl p_239052_1_, DimensionGeneratorSettings p_239052_2_) {
      ...
      this.field_239041_o_ = Long.toString(p_239052_2_.getSeed());
      this.field_239033_g_.setText(this.field_239041_o_);
      this.field_239035_i_.active = this.field_239040_n_.isPresent();
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      if (this.field_239034_h_.visible) {
         this.field_239031_e_.drawStringWithShadow(matrixStack, I18n.format("selectWorld.mapFeatures.info"), (float)(this.field_239032_f_ / 2 - 150), 122.0F, -6250336);
      }
      ...
      if (this.field_239040_n_.equals(Optional.of(BiomeGeneratorTypeScreens.field_239067_b_))) {
         this.field_239031_e_.func_238418_a_(field_239030_d_, this.field_239035_i_.x + 2, this.field_239035_i_.y + 22, this.field_239035_i_.getWidth(), 10526880);
      }
