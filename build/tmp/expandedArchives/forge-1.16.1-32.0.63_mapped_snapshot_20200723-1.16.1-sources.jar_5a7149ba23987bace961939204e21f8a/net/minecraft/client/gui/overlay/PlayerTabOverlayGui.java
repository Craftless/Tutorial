...
public class PlayerTabOverlayGui extends AbstractGui {
   ...
   public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
      ...
      if (this.header != null) {
         ...
         for(ITextProperties itextproperties : list1) {
            l1 = Math.max(l1, this.mc.fontRenderer.func_238414_a_(itextproperties));
         }
      }
      ...
      if (this.footer != null) {
         ...
         for(ITextProperties itextproperties1 : list2) {
            l1 = Math.max(l1, this.mc.fontRenderer.func_238414_a_(itextproperties1));
         }
      }
      ...
      if (list1 != null) {
         ...
         for(ITextProperties itextproperties2 : list1) {
            int i2 = this.mc.fontRenderer.func_238414_a_(itextproperties2);
            this.mc.fontRenderer.func_238407_a_(p_238523_1_, itextproperties2, (float)(p_238523_2_ / 2 - i2 / 2), (float)k1, -1);
            k1 += 9;
         }
      ...
      for(int i5 = 0; i5 < i4; ++i5) {
         ...
         if (i5 < list.size()) {
            ...
            this.mc.fontRenderer.func_238407_a_(p_238523_1_, this.getDisplayName(networkplayerinfo1), (float)k2, (float)l2, networkplayerinfo1.getGameType() == GameType.SPECTATOR ? -1862270977 : -1);
      ...
      if (list2 != null) {
         ...
         for(ITextProperties itextproperties3 : list2) {
            int k5 = this.mc.fontRenderer.func_238414_a_(itextproperties3);
            this.mc.fontRenderer.func_238407_a_(p_238523_1_, itextproperties3, (float)(p_238523_2_ / 2 - k5 / 2), (float)k1, -1);
            k1 += 9;
         }
      }
