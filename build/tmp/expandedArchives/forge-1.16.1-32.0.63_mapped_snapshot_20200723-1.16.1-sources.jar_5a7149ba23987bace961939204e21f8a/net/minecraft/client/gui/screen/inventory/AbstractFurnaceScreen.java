...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (this.recipeGui.mouseClicked(mouseX, mouseY, p_231044_5_)) {
         return true;
      } else {
         return this.widthTooNarrowIn && this.recipeGui.isVisible() ? true : super.mouseClicked(mouseX, mouseY, p_231044_5_);
      }
   }
