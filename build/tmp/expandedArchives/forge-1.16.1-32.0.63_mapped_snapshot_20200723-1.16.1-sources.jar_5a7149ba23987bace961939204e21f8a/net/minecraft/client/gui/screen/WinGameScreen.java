         ...
         try {
            ...
            if (this.poem) {
               ...
               while((s = bufferedreader.readLine()) != null) {
                  ...
                  this.lines.addAll(this.minecraft.fontRenderer.func_238420_b_().func_238365_g_(s, 274, Style.EMPTY));
                  this.lines.add(ITextProperties.field_240651_c_);
               }
            ...
            while((s3 = bufferedreader1.readLine()) != null) {
               ...
               for(ITextProperties itextproperties : this.minecraft.fontRenderer.func_238420_b_().func_238365_g_(s3, 274, Style.EMPTY)) {
                  if (flag) {
                     this.field_238664_v_.add(this.lines.size());
                  }

                  this.lines.add(itextproperties);
               }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      for(int i1 = 0; i1 < this.lines.size(); ++i1) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)this.height) {
            ITextProperties itextproperties = this.lines.get(i1);
            if (this.field_238664_v_.contains(i1)) {
               this.font.func_238407_a_(matrixStack, itextproperties, (float)(j + (274 - this.font.func_238414_a_(itextproperties)) / 2), (float)l, 16777215);
            } else {
               this.font.random.setSeed((long)((float)((long)i1 * 4238972211L) + this.time / 4.0F));
               this.font.func_238407_a_(matrixStack, itextproperties, (float)j, (float)l, 16777215);
            }
         }
