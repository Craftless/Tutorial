...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.commandTextField = new TextFieldWidget(this.font, this.width / 2 - 150, 50, 300, 20, new TranslationTextComponent("advMode.command")) {
         protected IFormattableTextComponent getNarrationMessage() {
            return super.getNarrationMessage().appendString(AbstractCommandBlockScreen.this.suggestionHelper.func_228129_c_());
         }
      };
   ...
   public boolean mouseScrolled(double mouseX, double mouseY, double p_231043_5_) {
      return this.suggestionHelper.onScroll(p_231043_5_) ? true : super.mouseScrolled(mouseX, mouseY, p_231043_5_);
   }

   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      return this.suggestionHelper.onClick(mouseX, mouseY, p_231044_5_) ? true : super.mouseClicked(mouseX, mouseY, p_231044_5_);
   }

   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      this.renderBackground(matrixStack);
      this.drawCenteredString(matrixStack, this.font, I18n.format("advMode.setCommand"), this.width / 2, 20, 16777215);
      this.drawString(matrixStack, this.font, I18n.format("advMode.command"), this.width / 2 - 150, 40, 10526880);
      ...
      if (!this.resultTextField.getText().isEmpty()) {
         ...
         this.drawString(matrixStack, this.font, I18n.format("advMode.previousOutput"), this.width / 2 - 150, i + 4, 10526880);
         this.resultTextField.render(matrixStack, mouseX, mouseY, partialTicks);
      }

      super.render(matrixStack, mouseX, mouseY, partialTicks);
      this.suggestionHelper.func_238500_a_(matrixStack, mouseX, mouseY);
   }
}