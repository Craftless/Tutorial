...
public class EditStructureScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, DialogTexts.field_240632_c_, (p_214274_1_) -> {
         this.func_195275_h();
      }));
      this.cancelButton = this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, DialogTexts.field_240633_d_, (p_214275_1_) -> {
         this.func_195272_i();
      }));
      ...
      this.nameEdit = new TextFieldWidget(this.font, this.width / 2 - 152, 40, 300, 20, new TranslationTextComponent("structure_block.structure_name")) {
         public boolean charTyped(char p_231042_1_, int p_231042_2_) {
            return !EditStructureScreen.this.isValidCharacterForName(this.getText(), p_231042_1_, this.getCursorPosition()) ? false : super.charTyped(p_231042_1_, p_231042_2_);
         }
      };
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (structuremode != StructureMode.DATA) {
         this.drawString(matrixStack, this.font, I18n.format("structure_block.structure_name"), this.width / 2 - 153, 30, 10526880);
      ...
      if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE) {
         this.drawString(matrixStack, this.font, I18n.format("structure_block.position"), this.width / 2 - 153, 70, 10526880);
         ...
         this.drawString(matrixStack, this.font, s, this.width / 2 + 154 - i, 150, 10526880);
      }

      if (structuremode == StructureMode.SAVE) {
         this.drawString(matrixStack, this.font, I18n.format("structure_block.size"), this.width / 2 - 153, 110, 10526880);
         ...
         this.drawString(matrixStack, this.font, s2, this.width / 2 + 154 - k, 110, 10526880);
         String s1 = I18n.format("structure_block.show_air");
         int j = this.font.getStringWidth(s1);
         this.drawString(matrixStack, this.font, s1, this.width / 2 + 154 - j, 70, 10526880);
      }

      if (structuremode == StructureMode.LOAD) {
         this.drawString(matrixStack, this.font, I18n.format("structure_block.integrity"), this.width / 2 - 153, 110, 10526880);
         ...
         this.drawString(matrixStack, this.font, s3, this.width / 2 + 154 - l, 70, 10526880);
      }

      if (structuremode == StructureMode.DATA) {
         this.drawString(matrixStack, this.font, I18n.format("structure_block.custom_data"), this.width / 2 - 153, 110, 10526880);
         this.dataEdit.render(matrixStack, mouseX, mouseY, partialTicks);
      }

      String s4 = "structure_block.mode_info." + structuremode.getString();
      this.drawString(matrixStack, this.font, I18n.format(s4), this.width / 2 - 153, 174, 10526880);
