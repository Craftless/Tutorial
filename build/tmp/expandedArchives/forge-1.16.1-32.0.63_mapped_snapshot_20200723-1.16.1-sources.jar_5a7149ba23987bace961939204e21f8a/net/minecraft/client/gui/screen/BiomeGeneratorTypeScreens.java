...
public abstract class BiomeGeneratorTypeScreens {
   public static final BiomeGeneratorTypeScreens field_239066_a_ = new BiomeGeneratorTypeScreens("default") {
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new OverworldBiomeProvider(p_230484_1_, false, false), p_230484_1_, DimensionSettings.Preset.OVERWORLD.getSettings());
      }
   };
   ...
   private static final BiomeGeneratorTypeScreens field_239071_f_ = new BiomeGeneratorTypeScreens("large_biomes") {
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new OverworldBiomeProvider(p_230484_1_, false, true), p_230484_1_, DimensionSettings.Preset.OVERWORLD.getSettings());
      }
   };
   public static final BiomeGeneratorTypeScreens field_239067_b_ = new BiomeGeneratorTypeScreens("amplified") {
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new OverworldBiomeProvider(p_230484_1_, false, false), p_230484_1_, DimensionSettings.Preset.AMPLIFIED.getSettings());
      }
   };
   private static final BiomeGeneratorTypeScreens field_239072_g_ = new BiomeGeneratorTypeScreens("single_biome_surface") {
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new SingleBiomeProvider(Biomes.PLAINS), p_230484_1_, DimensionSettings.Preset.OVERWORLD.getSettings());
      }
   };
   private static final BiomeGeneratorTypeScreens field_239073_h_ = new BiomeGeneratorTypeScreens("single_biome_caves") {
      ...
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new SingleBiomeProvider(Biomes.PLAINS), p_230484_1_, DimensionSettings.Preset.CAVES.getSettings());
      }
   };
   private static final BiomeGeneratorTypeScreens field_239074_i_ = new BiomeGeneratorTypeScreens("single_biome_floating_islands") {
      protected ChunkGenerator func_230484_a_(long p_230484_1_) {
         return new NoiseChunkGenerator(new SingleBiomeProvider(Biomes.PLAINS), p_230484_1_, DimensionSettings.Preset.FLOATING_ISLANDS.getSettings());
      }
   };
   ...
   protected static final Map<Optional<BiomeGeneratorTypeScreens>, BiomeGeneratorTypeScreens.IFactory> field_239069_d_ = ImmutableMap.of(Optional.of(field_239070_e_), (p_239089_0_, p_239089_1_) -> {
      ...
      return new CreateFlatWorldScreen(p_239089_0_, (p_239083_2_) -> {
         p_239089_0_.field_238934_c_.func_239043_a_(new DimensionGeneratorSettings(p_239089_1_.getSeed(), p_239089_1_.doesGenerateFeatures(), p_239089_1_.hasBonusChest(), DimensionGeneratorSettings.func_236216_a_(p_239089_1_.func_236224_e_(), new FlatChunkGenerator(p_239083_2_))));
   ...
   private static DimensionGeneratorSettings func_239080_a_(DimensionGeneratorSettings p_239080_0_, BiomeGeneratorTypeScreens p_239080_1_, Biome p_239080_2_) {
      ...
      if (p_239080_1_ == field_239073_h_) {
         dimensionsettings = DimensionSettings.Preset.CAVES.getSettings();
      } else if (p_239080_1_ == field_239074_i_) {
         dimensionsettings = DimensionSettings.Preset.FLOATING_ISLANDS.getSettings();
      } else {
         dimensionsettings = DimensionSettings.Preset.OVERWORLD.getSettings();
      }

      return new DimensionGeneratorSettings(p_239080_0_.getSeed(), p_239080_0_.doesGenerateFeatures(), p_239080_0_.hasBonusChest(), DimensionGeneratorSettings.func_236216_a_(p_239080_0_.func_236224_e_(), new NoiseChunkGenerator(biomeprovider, p_239080_0_.getSeed(), dimensionsettings)));
   }
