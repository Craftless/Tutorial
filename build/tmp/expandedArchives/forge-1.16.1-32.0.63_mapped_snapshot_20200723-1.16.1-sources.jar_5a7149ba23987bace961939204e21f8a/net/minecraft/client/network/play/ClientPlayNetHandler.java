...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   private IDynamicRegistries field_239163_t_ = IDynamicRegistries.func_239770_b_();
   ...
   public void handleJoinGame(SJoinGamePacket packetIn) {
      ...
      if (!this.netManager.isLocalChannel()) {
         BlockTags.func_232890_a_();
         ItemTags.func_232915_a_();
         FluidTags.func_232899_a_();
         EntityTypeTags.func_232895_a_();
      }
      ...
      RegistryKey<DimensionType> registrykey = packetIn.func_240818_h_();
      RegistryKey<World> registrykey1 = packetIn.func_240819_i_();
      DimensionType dimensiontype = this.field_239163_t_.func_230520_a_().getValueForKey(registrykey);
      ...
      this.world = new ClientWorld(this, clientworld$clientworldinfo, registrykey1, registrykey, dimensiontype, this.viewDistance, this.client::getProfiler, this.client.worldRenderer, flag, packetIn.getHashedSeed());
      ...
      if (entity != null) {
         if (!entity.canPassengerSteer()) {
            if (packetIn.func_229745_h_()) {
               ...
               Vector3d vector3d = SEntityPacket.func_218744_a(entity.serverPosX, entity.serverPosY, entity.serverPosZ);
               ...
               entity.setPositionAndRotationDirect(vector3d.x, vector3d.y, vector3d.z, f, f1, 3, false);
   ...
   public void handleChunkData(SChunkDataPacket packetIn) {
      ...
      Chunk chunk = this.world.getChunkProvider().loadChunk(i, j, packetIn.getBiomes(), packetIn.getReadBuffer(), packetIn.getHeightmapTags(), packetIn.getAvailableSections(), packetIn.isFullChunk());
      ...
      if (!packetIn.func_241782_g_()) {
         this.world.getLightManager().enableLightSources(chunk.getPos(), false);
         int l = packetIn.getAvailableSections();

         for(int i1 = 0; i1 < 16; ++i1) {
            if ((l & 1 << i1) != 0) {
               this.world.getLightManager().setData(LightType.BLOCK, SectionPos.from(chunk.getPos(), i1), new NibbleArray(), false);
               this.world.getLightManager().setData(LightType.SKY, SectionPos.from(chunk.getPos(), i1), new NibbleArray(), false);
            }
         }

         this.world.getLightManager().tick(Integer.MAX_VALUE, true, true);
         this.world.getLightManager().enableLightSources(chunk.getPos(), true);
         chunk.getLightSources().forEach((p_241666_2_) -> {
            this.world.getLightManager().onBlockEmissionIncrease(p_241666_2_, chunk.getLightValue(p_241666_2_));
         });
      }
   ...
   public void onDisconnect(ITextComponent reason) {
      ...
      if (this.guiScreenServer != null) {
         if (this.guiScreenServer instanceof RealmsScreen) {
            this.client.displayGuiScreen(new DisconnectedRealmsScreen(this.guiScreenServer, "disconnect.lost", reason));
         } else {
   ...
   public void func_230488_a_(SWorldSpawnChangedPacket p_230488_1_) {
      ...
      this.client.world.func_239136_a_(p_230488_1_.func_240832_b_());
   }
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      RegistryKey<DimensionType> registrykey = packetIn.func_240826_b_();
      RegistryKey<World> registrykey1 = packetIn.func_240827_c_();
      DimensionType dimensiontype = this.field_239163_t_.func_230520_a_().getValueForKey(registrykey);
      ClientPlayerEntity clientplayerentity = this.client.player;
      int i = clientplayerentity.getEntityId();
      this.doneLoadingTerrain = false;
      if (registrykey1 != clientplayerentity.world.func_234923_W_()) {
   ...
   public void handleTags(STagsListPacket packetIn) {
      ...
      if (!this.netManager.isLocalChannel()) {
         this.networkTagManager.updateTags();
   ...
   public IDynamicRegistries func_239165_n_() {
