...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
   ...
   public static IServerConfiguration func_238181_a_(SaveFormat.LevelSave p_238181_0_, IDynamicRegistries.Impl p_238181_1_, IResourceManager p_238181_2_, DatapackCodec p_238181_3_) {
      WorldSettingsImport<INBT> worldsettingsimport = WorldSettingsImport.func_240876_a_(NBTDynamicOps.INSTANCE, p_238181_2_, p_238181_1_);
   ...
   public void func_238191_a_(String p_238191_1_) {
      this.func_238195_a_(p_238191_1_, IDynamicRegistries.func_239770_b_(), Minecraft::func_238180_a_, Minecraft::func_238181_a_, false, Minecraft.WorldSelectionType.BACKUP);
   }
   ...
   public void func_238192_a_(String p_238192_1_, WorldSettings p_238192_2_, IDynamicRegistries.Impl p_238192_3_, DimensionGeneratorSettings p_238192_4_) {
      this.func_238195_a_(p_238192_1_, p_238192_3_, (p_238179_1_) -> {
         ...
         WorldSettingsImport<JsonElement> worldsettingsimport = WorldSettingsImport.func_240876_a_(JsonOps.INSTANCE, p_238187_5_, p_238192_3_);
         DataResult<SimpleRegistry<Dimension>> dataresult = worldsettingsimport.func_241797_a_(p_238192_4_.func_236224_e_(), Registry.DIMENSION_KEY, Dimension.DIMENSION_CODEC);
         SimpleRegistry<Dimension> simpleregistry = dataresult.resultOrPartial(LOGGER::error).orElse(p_238192_4_.func_236224_e_());
   ...
   private void func_238195_a_(String p_238195_1_, IDynamicRegistries.Impl p_238195_2_, Function<SaveFormat.LevelSave, DatapackCodec> p_238195_3_, Function4<SaveFormat.LevelSave, IDynamicRegistries.Impl, IResourceManager, DatapackCodec, IServerConfiguration> p_238195_4_, boolean p_238195_5_, Minecraft.WorldSelectionType p_238195_6_) {
      ...
      if (this.currentScreen instanceof WinGameScreen) {
         ...
         if (this.player.world.func_234923_W_() == World.field_234920_i_) {
            ...
            if (!this.musicTicker.func_239540_b_(BackgroundMusicTracks.field_232675_f_) && (!this.player.canSwim() || biome$category != Biome.Category.OCEAN && biome$category != Biome.Category.RIVER)) {
               return this.player.world.func_234923_W_() != World.field_234919_h_ && this.player.abilities.isCreativeMode && this.player.abilities.allowFlying ? BackgroundMusicTracks.field_232671_b_ : this.world.getBiomeManager().func_235201_b_(this.player.getPosition()).func_235094_x_().orElse(BackgroundMusicTracks.field_232676_g_);
            } else {
   ...
   private static ClientResourcePackInfo makePackInfo(String name, boolean isAlwaysEnabled, Supplier<IResourcePack> p_228011_2_, IResourcePack p_228011_3_, PackMetadataSection p_228011_4_, ResourcePackInfo.Priority priority, IPackNameDecorator p_228011_6_) {
