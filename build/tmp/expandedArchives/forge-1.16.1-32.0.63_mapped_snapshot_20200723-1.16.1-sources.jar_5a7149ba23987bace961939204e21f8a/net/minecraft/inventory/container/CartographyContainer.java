...
public class CartographyContainer extends Container {
   ...
   public CartographyContainer(int id, PlayerInventory playerInventory, final IWorldPosCallable worldPosCallable) {
      ...
      this.addSlot(new Slot(this.field_217001_f, 2, 145, 39) {
         ...
         public ItemStack decrStackSize(int amount) {
            ...
            ItemStack itemstack1 = worldPosCallable.apply((p_216936_2_, p_216936_3_) -> {
               if (!CartographyContainer.this.field_217000_e && CartographyContainer.this.tableInventory.getStackInSlot(1).getItem() == Items.GLASS_PANE) {
                  ItemStack itemstack2 = FilledMapItem.func_219992_b(p_216936_2_, CartographyContainer.this.tableInventory.getStackInSlot(0));
                  if (itemstack2 != null) {
            ...
            CartographyContainer.this.tableInventory.decrStackSize(0, 1);
            CartographyContainer.this.tableInventory.decrStackSize(1, 1);
            return itemstack1;
         }
         ...
         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            ...
            worldPosCallable.consume((p_216935_1_, p_216935_2_) -> {
   ...
   public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
      ...
      if (slot != null && slot.getHasStack()) {
         ...
         if (index == 2) {
            if (this.tableInventory.getStackInSlot(1).getItem() == Items.GLASS_PANE) {
               itemstack2 = this.worldPosCallable.apply((p_216997_2_, p_216997_3_) -> {
                  ItemStack itemstack3 = FilledMapItem.func_219992_b(p_216997_2_, this.tableInventory.getStackInSlot(0));
                  if (itemstack3 != null) {
