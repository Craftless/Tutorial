...
public class RecipeBook {
   ...
   @OnlyIn(Dist.CLIENT)
   public boolean isFilteringCraftable(RecipeBookContainer<?> recipeBookContainer) {
      if (recipeBookContainer instanceof FurnaceContainer) {
         return this.isFurnaceFilteringCraftable;
      } else if (recipeBookContainer instanceof BlastFurnaceContainer) {
         return this.isBlastFurnaceFilteringCraftable;
      } else {
         return recipeBookContainer instanceof SmokerContainer ? this.isSmokerFilteringCraftable : this.isFilteringCraftable;
      }
   }
