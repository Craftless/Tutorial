...
public class ServerRecipeBook extends RecipeBook {
   ...
   public CompoundNBT write() {
      ...
      compoundnbt.putBoolean("isBlastingFurnaceGuiOpen", this.isBlastFurnaceGuiOpen);
      compoundnbt.putBoolean("isBlastingFurnaceFilteringCraftable", this.isBlastFurnaceFilteringCraftable);
      compoundnbt.putBoolean("isSmokerGuiOpen", this.isSmokerGuiOpen);
      compoundnbt.putBoolean("isSmokerFilteringCraftable", this.isSmokerFilteringCraftable);
   ...
   public void read(CompoundNBT tag, RecipeManager p_192825_2_) {
      ...
      this.isBlastFurnaceGuiOpen = tag.getBoolean("isBlastingFurnaceGuiOpen");
      this.isBlastFurnaceFilteringCraftable = tag.getBoolean("isBlastingFurnaceFilteringCraftable");
      this.isSmokerGuiOpen = tag.getBoolean("isSmokerGuiOpen");
      this.isSmokerFilteringCraftable = tag.getBoolean("isSmokerFilteringCraftable");
