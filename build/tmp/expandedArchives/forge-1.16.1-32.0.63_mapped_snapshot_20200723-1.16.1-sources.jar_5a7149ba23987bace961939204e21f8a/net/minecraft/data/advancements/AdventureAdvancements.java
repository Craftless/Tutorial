...
public class AdventureAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    */
   protected static Advancement.Builder makeBiomeAdvancement(Advancement.Builder p_204285_0_, Biome[] builder) {
      for(Biome biome : builder) {
         p_204285_0_.withCriterion(Registry.BIOME.getKey(biome).toString(), PositionTrigger.Instance.forLocation(LocationPredicate.forBiome(biome)));
      }
