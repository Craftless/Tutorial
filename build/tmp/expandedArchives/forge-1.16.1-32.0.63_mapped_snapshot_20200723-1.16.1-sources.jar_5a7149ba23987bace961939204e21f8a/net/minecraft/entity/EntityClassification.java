...
public enum EntityClassification implements IStringSerializable, net.minecraftforge.common.IExtensibleEnum {
   ...
   public static final Codec<EntityClassification> CLASSIFICATION_CODEC = IStringSerializable.createEnumCodec(EntityClassification::values, EntityClassification::getClassificationByName);
