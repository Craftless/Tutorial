...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public PlayerEntity(World p_i231577_1_, BlockPos p_i231577_2_, GameProfile p_i231577_3_) {
      super(EntityType.PLAYER, p_i231577_1_);
      this.setUniqueId(getUUID(p_i231577_3_));
      this.gameProfile = p_i231577_3_;
      this.container = new PlayerContainer(this.inventory, !p_i231577_1_.isRemote, this);
      this.openContainer = this.container;
      this.setLocationAndAngles((double)p_i231577_2_.getX() + 0.5D, (double)(p_i231577_2_.getY() + 1), (double)p_i231577_2_.getZ() + 0.5D, 0.0F, 0.0F);
   ...
   public static AttributeModifierMap.MutableAttribute func_234570_el_() {
      return LivingEntity.registerAttributes().createMutableAttribute(Attributes.ATTACK_DAMAGE, 1.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, (double)0.1F).createMutableAttribute(Attributes.ATTACK_SPEED).createMutableAttribute(Attributes.LUCK).createMutableAttribute(net.minecraftforge.common.ForgeMod.REACH_DISTANCE.get());
   }
   ...
   public boolean func_234569_d_(BlockState p_234569_1_) {
      return net.minecraftforge.event.ForgeEventFactory.doPlayerHarvestCheck(this, p_234569_1_, !p_234569_1_.getRequiresTool() || this.inventory.getCurrentItem().canHarvestBlock(p_234569_1_));
   }
   ...
   protected Vector3d maybeBackOffFromEdge(Vector3d vec, MoverType mover) {
      if ((mover == MoverType.SELF || mover == MoverType.PLAYER) && this.onGround && this.isStayingOnGroundSurface()) {
         double d0 = vec.x;
         double d1 = vec.z;
         double d2 = 0.05D;
   ...
   public ITextComponent getDisplayName() {
      ...
      iformattabletextcomponent = iformattabletextcomponent.append(ScorePlayerTeam.func_237500_a_(this.getTeam(), this.getName()));
   ...
   public ITextComponent getDisplayNameAndUUID() {
      return (new StringTextComponent("")).append(this.getName()).appendString(" (").appendString(this.gameProfile.getId().toString()).appendString(")");
   }
