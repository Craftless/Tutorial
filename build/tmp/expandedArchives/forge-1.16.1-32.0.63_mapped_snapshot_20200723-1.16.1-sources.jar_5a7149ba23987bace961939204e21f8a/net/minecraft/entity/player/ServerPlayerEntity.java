...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   public ServerPlayerEntity(MinecraftServer server, ServerWorld worldIn, GameProfile profile, PlayerInteractionManager interactionManagerIn) {
      super(worldIn, worldIn.func_241135_u_(), profile);
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      if (this.field_241138_cr_ != null) {
         ...
         ResourceLocation.RESOURCE_LOCATION_CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.field_241137_cq_.func_240901_a_()).resultOrPartial(LOGGER::error).ifPresent((p_241148_1_) -> {
   ...
   public Entity changeDimension(ServerWorld server, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      if (registrykey == World.field_234920_i_ && server.func_234923_W_() == World.field_234918_g_ && teleporter instanceof net.minecraft.world.Teleporter) { //Forge: Fix non-vanilla teleporters triggering end credits
         this.detach();
   ...
   public Either<PlayerEntity.SleepResult, Unit> trySleep(BlockPos at) {
      ...
      if (!this.isSleeping() && this.isAlive()) {
         if (!this.world.func_230315_m_().func_236043_f_()) {
            ...
            this.func_241153_a_(this.world.func_234923_W_(), at, false, true);
   ...
   public void func_241153_a_(RegistryKey<World> p_241153_1_, @Nullable BlockPos p_241153_2_, boolean p_241153_3_, boolean p_241153_4_) {
      if (p_241153_2_ != null) {
         ...
         this.field_241138_cr_ = p_241153_2_;
         this.field_241137_cq_ = p_241153_1_;
         this.field_241139_cs_ = p_241153_3_;
      } else {
