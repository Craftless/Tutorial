...
public class ZoglinEntity extends MonsterEntity implements IMob, IFlinging {
   ...
   private static void func_234328_a_(Brain<ZoglinEntity> p_234328_0_) {
      p_234328_0_.func_233698_a_(Activity.CORE, 0, ImmutableList.of(new LookTask(45, 90), new WalkToTargetTask(200)));
   }
   ...
   private static boolean func_234337_j_(LivingEntity p_234337_0_) {
      ...
      return entitytype != EntityType.ZOGLIN && entitytype != EntityType.CREEPER && EntityPredicates.field_233583_f_.test(p_234337_0_);
   }
