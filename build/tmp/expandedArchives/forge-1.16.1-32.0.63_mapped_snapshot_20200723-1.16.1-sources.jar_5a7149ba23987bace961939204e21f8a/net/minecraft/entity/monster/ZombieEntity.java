...
public class ZombieEntity extends MonsterEntity {
   ...
   protected void func_234341_c_(EntityType<? extends ZombieEntity> p_234341_1_) {
      ZombieEntity zombieentity = this.func_233656_b_(p_234341_1_);
   ...
   public void onKillEntity(LivingEntity entityLivingIn) {
      ...
      if ((this.world.getDifficulty() == Difficulty.NORMAL || this.world.getDifficulty() == Difficulty.HARD) && entityLivingIn instanceof VillagerEntity) {
         ...
         zombievillagerentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(zombievillagerentity.getPosition()), SpawnReason.CONVERSION, new ZombieEntity.GroupData(false, true), (CompoundNBT)null);
