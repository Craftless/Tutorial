...
public class EndermanEntity extends MonsterEntity implements IAngerable {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(2, new EndermanEntity.FindPlayerGoal(this));
      this.targetSelector.addGoal(3, new HurtByTargetGoal(this));
      this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, EndermiteEntity.class, 10, true, false, field_213627_bA));
