...
public class PiglinTasks {
   ...
   private static void func_234464_a_(Brain<PiglinEntity> p_234464_0_) {
      p_234464_0_.func_233698_a_(Activity.CORE, 0, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new LookTask(45, 90), new WalkToTargetTask(200), new InteractWithDoorTask(), func_241428_d_(), func_234500_d_(), new StartAdmiringItemTask(), new AdmireItemTask(120), new EndAttackTask(300, PiglinTasks::func_234461_a_), new GetAngryTask()));
   }
   ...
   private static void func_234502_d_(Brain<PiglinEntity> p_234502_0_) {
      p_234502_0_.func_233699_a_(Activity.ADMIRE_ITEM, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new PickupWantedItemTask<>(PiglinTasks::func_234455_E_, 1.0F, true, 9), new ForgetAdmiredItemTask(9)), MemoryModuleType.ADMIRING_ITEM);
   }
   ...
   private static void func_234509_e_(PiglinEntity p_234509_0_, LivingEntity p_234509_1_) {
   ...
   private static List<PiglinEntity> func_234529_p_(PiglinEntity p_234529_0_) {
      return p_234529_0_.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLINS).orElse(ImmutableList.of());
   }

   private static List<PiglinEntity> func_234530_q_(PiglinEntity p_234530_0_) {
   ...
   protected static void func_241430_f_(PiglinEntity p_241430_0_) {
   ...
   protected static void func_234497_c_(PiglinEntity p_234497_0_, LivingEntity p_234497_1_) {
   ...
   private static void func_241431_f_(PiglinEntity p_241431_0_, LivingEntity p_241431_1_) {
   ...
   private static void func_234513_f_(PiglinEntity p_234513_0_, LivingEntity p_234513_1_) {
   ...
   private static Optional<LivingEntity> func_234532_s_(PiglinEntity p_234532_0_) {
   ...
   public static Optional<PlayerEntity> func_241432_i_(PiglinEntity p_241432_0_) {
   ...
   protected static void func_234518_h_(PiglinEntity p_234518_0_) {
   ...
   protected static boolean func_234520_i_(PiglinEntity p_234520_0_) {
