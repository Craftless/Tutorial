...
public class PiglinEntity extends MonsterEntity implements ICrossbowUser {
   ...
   private static final DataParameter<Boolean> field_234408_bu_ = EntityDataManager.createKey(PiglinEntity.class, DataSerializers.BOOLEAN);
   ...
   protected static final ImmutableList<SensorType<? extends Sensor<? super PiglinEntity>>> field_234405_b_ = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.field_234129_b_, SensorType.HURT_BY, SensorType.INTERACTABLE_DOORS, SensorType.field_234130_l_);
   ...
   public PiglinEntity(EntityType<? extends MonsterEntity> p_i231570_1_, World p_i231570_2_) {
   ...
   protected void registerData() {
      ...
      this.dataManager.register(field_234408_bu_, false);
   ...
   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if (actionresulttype.isSuccessOrConsume()) {
         ...
         boolean flag = PiglinTasks.func_234489_b_(this, p_230254_1_.getHeldItem(p_230254_2_)) && this.func_234424_eM_() != PiglinEntity.Action.ADMIRING_ITEM;
   ...
   public boolean func_234421_eJ_() {
      return !this.isChild();
   }

   public void setImmuneToZombification(boolean p_234441_1_) {
      this.getDataManager().set(field_234408_bu_, p_234441_1_);
   }
   ...
   private void func_234416_a_(ServerWorld p_234416_1_) {
      ...
      this.inventory.func_233543_f_().forEach(this::entityDropItem);
      ZombifiedPiglinEntity zombifiedpiglinentity = this.func_233656_b_(EntityType.ZOMBIFIED_PIGLIN);
   ...
   public PiglinEntity.Action func_234424_eM_() {
      if (this.func_234425_eN_()) {
         return PiglinEntity.Action.DANCING;
      } else if (PiglinTasks.func_234480_a_(this.getHeldItemOffhand().getItem())) {
         return PiglinEntity.Action.ADMIRING_ITEM;
      } else if (this.isAggressive() && this.func_234434_eY_()) {
         return PiglinEntity.Action.ATTACKING_WITH_MELEE_WEAPON;
      } else if (this.func_234433_eX_()) {
         return PiglinEntity.Action.CROSSBOW_CHARGE;
      } else {
         return this.isAggressive() && this.canEquip(Items.CROSSBOW) ? PiglinEntity.Action.CROSSBOW_HOLD : PiglinEntity.Action.DEFAULT;
      }
   }
   ...
   public boolean func_230293_i_(ItemStack p_230293_1_) {
      return this.world.getGameRules().getBoolean(GameRules.MOB_GRIEFING) && PiglinTasks.func_234474_a_(this, p_230293_1_);
   }
