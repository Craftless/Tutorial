...
public class MemoryModuleType<U> extends net.minecraftforge.registries.ForgeRegistryEntry<MemoryModuleType<?>> {
   ...
   public static final MemoryModuleType<GlobalPos> HOME = registerWithCodec("home", GlobalPos.field_239645_a_);
   public static final MemoryModuleType<GlobalPos> JOB_SITE = registerWithCodec("job_site", GlobalPos.field_239645_a_);
   public static final MemoryModuleType<GlobalPos> POTENTIAL_JOB_SITE = registerWithCodec("potential_job_site", GlobalPos.field_239645_a_);
   public static final MemoryModuleType<GlobalPos> MEETING_POINT = registerWithCodec("meeting_point", GlobalPos.field_239645_a_);
   ...
   public static final MemoryModuleType<UUID> ANGRY_AT = registerWithCodec("angry_at", UUIDCodec.UUID_CODEC);
