...
public class GatherPOITask extends Task<CreatureEntity> {
   ...
   protected void startExecuting(ServerWorld worldIn, CreatureEntity entityIn, long gameTimeIn) {
      ...
      Set<BlockPos> set = pointofinterestmanager.findAll(this.field_220604_a.getPredicate(), predicate, entityIn.getPosition(), 48, PointOfInterestManager.Status.HAS_SPACE).limit(5L).collect(Collectors.toSet());
