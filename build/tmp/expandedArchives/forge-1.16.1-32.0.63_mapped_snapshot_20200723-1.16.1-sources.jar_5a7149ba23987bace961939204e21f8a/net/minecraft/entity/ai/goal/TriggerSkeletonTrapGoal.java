...
public class TriggerSkeletonTrapGoal extends Goal {
    ...
    */
   public void tick() {
      DifficultyInstance difficultyinstance = this.horse.world.getDifficultyForLocation(this.horse.getPosition());
      this.horse.setTrap(false);
      this.horse.setHorseTamed(true);
      this.horse.setGrowingAge(0);
      LightningBoltEntity lightningboltentity = EntityType.LIGHTNING_BOLT.create(this.horse.world);
      lightningboltentity.moveForced(this.horse.getPosX(), this.horse.getPosY(), this.horse.getPosZ());
      lightningboltentity.setEffectOnly(true);
      this.horse.world.addEntity(lightningboltentity);
   ...
   private SkeletonEntity createSkeleton(DifficultyInstance p_188514_1_, AbstractHorseEntity horse) {
      ...
      skeletonentity.onInitialSpawn(horse.world, p_188514_1_, SpawnReason.TRIGGERED, (ILivingEntityData)null, (CompoundNBT)null);
