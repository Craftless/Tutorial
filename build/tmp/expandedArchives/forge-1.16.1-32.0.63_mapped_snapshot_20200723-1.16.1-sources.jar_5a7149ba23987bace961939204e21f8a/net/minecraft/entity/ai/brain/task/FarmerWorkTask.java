...
public class FarmerWorkTask extends SpawnGolemTask {
   ...
   private void func_234016_a_(ServerWorld p_234016_1_, VillagerEntity p_234016_2_, GlobalPos p_234016_3_, BlockState p_234016_4_) {
      if (p_234016_4_.get(ComposterBlock.LEVEL) == 8) {
         p_234016_4_ = ComposterBlock.empty(p_234016_4_, p_234016_1_, p_234016_3_.getPos());
      }
         ...
         if (i1 != -1) {
            ...
            if (l1 > 0) {
               ...
               for(int i2 = 0; i2 < l1; ++i2) {
                  p_234016_4_ = ComposterBlock.attemptFill(p_234016_4_, p_234016_1_, itemstack, p_234016_3_.getPos());
                  if (p_234016_4_.get(ComposterBlock.LEVEL) == 7) {
                     return;
                  }
               }
            }
