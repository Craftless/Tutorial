...
public abstract class LivingEntity extends Entity {
   ...
   protected boolean func_230296_cM_() {
      return this.getStateBelow().isIn(BlockTags.SOUL_SPEED_BLOCKS);
   }
   ...
   public void applyKnockback(float strength, double ratioX, double ratioZ) {
       //TODO, Vanilla removed the attacker entity from this method, 1.15-mcp: knockBack
   ...
   public void wakeUp() {
      this.getBedPosition().filter(this.world::isBlockLoaded).ifPresent((p_241348_1_) -> {
         ...
         if (blockstate.isBed(world, p_241348_1_, this)) {
            ...
            Vector3d vector3d1 = BedBlock.getBedSpawnPosition(this.getType(), this.world, p_241348_1_, 0).orElseGet(() -> {
