...
public class RegistryKey<T> {
   ...
   public static <T> RegistryKey<T> func_240903_a_(RegistryKey<Registry<T>> p_240903_0_, ResourceLocation p_240903_1_) {
   ...
   public static <T> Function<ResourceLocation, RegistryKey<T>> func_240902_a_(RegistryKey<Registry<T>> p_240902_0_) {
      return (p_240907_1_) -> {
