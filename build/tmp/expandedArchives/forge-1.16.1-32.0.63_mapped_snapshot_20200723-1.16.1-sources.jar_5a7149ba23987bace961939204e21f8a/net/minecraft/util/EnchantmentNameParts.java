...
public class EnchantmentNameParts {
   ...
   private static final Style field_238815_b_ = Style.EMPTY.setFontId(field_238814_a_);
   ...
   public ITextProperties func_238816_a_(FontRenderer p_238816_1_, int p_238816_2_) {
      ...
      return p_238816_1_.func_238420_b_().func_238358_a_((new StringTextComponent(stringbuilder.toString())).mergeStyle(field_238815_b_), p_238816_2_, Style.EMPTY);
   }
