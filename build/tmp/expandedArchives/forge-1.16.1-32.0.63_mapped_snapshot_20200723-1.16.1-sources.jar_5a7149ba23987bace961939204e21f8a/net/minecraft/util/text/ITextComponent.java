...
public interface ITextComponent extends Message, ITextProperties {
   ...
   @OnlyIn(Dist.CLIENT)
   static ITextComponent func_241827_a_(@Nullable String p_241827_0_) {
      return (ITextComponent)(p_241827_0_ != null ? new StringTextComponent(p_241827_0_) : StringTextComponent.EMPTY);
   }
