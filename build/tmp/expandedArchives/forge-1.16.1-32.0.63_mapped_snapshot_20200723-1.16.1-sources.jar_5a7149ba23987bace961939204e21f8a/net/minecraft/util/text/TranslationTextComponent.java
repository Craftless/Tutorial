...
public class TranslationTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   private void ensureInitialized() {
      ...
      if (languagemap != this.field_240756_i_) {
         ...
         try {
            this.func_240758_a_(languagemap.func_230504_a_(s, true), languagemap);
   ...
   private void func_240758_a_(String p_240758_1_, LanguageMap p_240758_2_) {
         ...
         for(j = 0; matcher.find(j); j = l) {
            ...
            if ("%".equals(s4) && "%%".equals(s1)) {
               ...
               if (i1 < this.formatArgs.length) {
                  this.children.add(this.func_240757_a_(i1, p_240758_2_));
               }
            }
         }
   ...
   private ITextProperties func_240757_a_(int p_240757_1_, LanguageMap p_240757_2_) {
      if (p_240757_1_ >= this.formatArgs.length) {
         ...
         if (object instanceof ITextComponent) {
            ...
            return object == null ? field_240755_f_ : ITextProperties.func_240652_a_(p_240757_2_.func_230504_a_(object.toString(), false));
         }
      }
   }
