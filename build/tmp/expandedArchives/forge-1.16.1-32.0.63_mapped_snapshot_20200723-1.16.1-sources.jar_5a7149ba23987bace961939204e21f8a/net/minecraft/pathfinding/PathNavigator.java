...
public abstract class PathNavigator {
   ...
   private boolean func_234112_b_(Vector3d p_234112_1_) {
      if (this.currentPath.getCurrentPathLength() <= this.currentPath.getCurrentPathIndex() + 1) {
         return false;
      } else {
         Vector3d vector3d = Vector3d.copyCenteredHorizontally(this.currentPath.getPathPointFromIndex(this.currentPath.getCurrentPathIndex()).func_224759_a());
         if (!p_234112_1_.isWithinDistanceOf(vector3d, 2.0D)) {
            return false;
         } else {
            Vector3d vector3d1 = Vector3d.copyCenteredHorizontally(this.currentPath.getPathPointFromIndex(this.currentPath.getCurrentPathIndex() + 1).func_224759_a());
