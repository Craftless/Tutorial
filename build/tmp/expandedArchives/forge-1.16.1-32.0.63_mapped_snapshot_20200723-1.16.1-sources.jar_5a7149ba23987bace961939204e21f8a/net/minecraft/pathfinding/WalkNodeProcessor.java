...
public class WalkNodeProcessor extends NodeProcessor {
         ...
         for(int i1 = -1; i1 <= 1; ++i1) {
            for(int j1 = -1; j1 <= 1; ++j1) {
               if (l != 0 || j1 != 0) {
                  ...
                  FluidState fluidstate = p_237232_0_.getFluidState(p_237232_1_);
   ...
   protected static PathNodeType func_237238_b_(IBlockReader p_237238_0_, BlockPos p_237238_1_) {
      ...
      if (blockstate.isAir(p_237238_0_, p_237238_1_)) {
         ...
         if (blockstate.isIn(Blocks.CACTUS)) {
            ...
            if (!blockstate.allowsMovement(p_237238_0_, p_237238_1_, PathType.LAND)) {
               ...
               if (fluidstate.isTagged(FluidTags.WATER)) {
                  ...
                  return fluidstate.isTagged(FluidTags.LAVA) ? PathNodeType.LAVA : PathNodeType.OPEN;
               }
            }
         } else {
            return PathNodeType.FENCE;
   ...
   private static boolean func_237233_a_(BlockState p_237233_0_) {
      return p_237233_0_.isIn(BlockTags.FIRE) || p_237233_0_.isIn(Blocks.MAGMA_BLOCK) || CampfireBlock.isLit(p_237233_0_);
   }
}