...
@OnlyIn(Dist.CLIENT)
public class FiveTimesTNTRenderer extends EntityRenderer<FiveTimesTNTEntity> {
   public FiveTimesTNTRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
      this.shadowSize = 0.5F;
   }

   public void render(FiveTimesTNTEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
...
@Override
public ResourceLocation getEntityTexture(FiveTimesTNTEntity entity) {
	return null;
}
}